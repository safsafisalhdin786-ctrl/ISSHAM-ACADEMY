 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ki=new Map,$_=new Map,Aa=new Map;function pu(r,e){try{r.container.addComponent(e)}catch(t){Et.debug(`Component ${e.name} failed to register with FirebaseApp ${r.name}`,t)}}function xn(r){const e=r.name;if(Aa.has(e))return Et.debug(`There were multiple attempts to register component ${e}.`),!1;Aa.set(e,r);for(const t of ki.values())pu(t,r);for(const t of $_.values())pu(t,r);return!0}function so(r,e){const t=r.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),r.container.getProvider(e)}function yt(r){return r.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Di=new sl("@firebase/auth");function sy(r,...e){Di.logLevel<=te.WARN&&Di.warn(`Auth (${Pn}): ${r}`,...e)}function pi(r,...e){Di.logLevel<=te.ERROR&&Di.error(`Auth (${Pn}): ${r}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gi(r,e,t){return`firebase:${r}:${e}:${t}`}class er{constructor(e,t,n){this.persistence=e,this.auth=t,this.userKey=n;const{config:s,name:i}=this.auth;this.fullUserKey=gi(this.userKey,s.apiKey,i),this.fullPersistenceKey=gi("persistence",s.apiKey,i),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?bt._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,n="authUser"){if(!t.length)return new er(xt(Iu),e,n);const s=(await Promise.all(t.map(async d=>{if(await d._isAvailable())return d}))).filter(d=>d);let i=s[0]||xt(Iu);const o=gi(n,e.config.apiKey,e.name);let l=null;for(const d of t)try{const m=await d._get(o);if(m){const p=bt._fromJSON(e,m);d!==i&&(l=p),i=d;break}}catch{}const c=s.filter(d=>d._shouldAllowMigration);return!i._shouldAllowMigration||!c.length?new er(i,e,n):(i=c[0],l&&await i._set(o,l.toJSON()),await Promise.all(t.map(async d=>{if(d!==i)try{await d._remove(o)}catch{}})),new er(i,e,n))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oy(r,e){const t=so(r,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(is(i,e??{}))return s;rt(s,"already-initialized")}return t.initialize({options:e})}function My(r,e){const t=e?.persistence||[],n=(Array.isArray(t)?t:[t]).map(xt);e?.errorMap&&r._updateErrorMap(e.errorMap),r._initializeWithPersistence(n,e?.popupRedirectResolver)}function Ly(r,e,t){const n=_r(r);J(n._canInitEmulator,n,"emulator-config-failed"),J(/^https?:\/\//.test(e),n,"invalid-emulator-scheme");const s=!1,i=zd(e),{host:o,port:l}=Fy(e),c=l===null?"":`:${l}`;n.config.emulator={url:`${i}//${o}${c}/`},n.settings.appVerificationDisabledForTesting=!0,n.emulatorConfig=Object.freeze({host:o,port:l,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})}),Uy()}function zd(r){const e=r.indexOf(":");return e<0?"":r.substr(0,e+1)}function Fy(r){const e=zd(r),t=/(\/\/)?([^?#/]+)/.exec(r.substr(e.length));if(!t)return{host:"",port:null};const n=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(n);if(s){const i=s[1];return{host:i,port:Ru(n.substr(i.length+1))}}else{const[i,o]=n.split(":");return{host:i,port:Ru(o)}}}function Ru(r){if(!r)return null;const e=Number(r);return isNaN(e)?null:e}function Uy(){function r(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",r):r())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qy(r,e){return io(r,"POST","/v1/accounts:signInWithPassword",Cn(r,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $y(r,e){return io(r,"POST","/v1/accounts:signInWithEmailLink",Cn(r,e))}async function zy(r,e){return io(r,"POST","/v1/accounts:signInWithEmailLink",Cn(r,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tr(r,e){return io(r,"POST","/v1/accounts:signInWithIdp",Cn(r,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ji extends mt{constructor(e,t,n,s){var i;super(t.code,t.message),this.operationType=n,this.user=s,Object.setPrototypeOf(this,ji.prototype),this.customData={appName:e.name,tenantId:(i=e.tenantId)!==null&&i!==void 0?i:void 0,_serverResponse:t.customData._serverResponse,operationType:n}}static _fromErrorAndOperation(e,t,n,s){return new ji(e,t,n,s)}}function Gd(r,e,t,n){return(e==="reauthenticate"?t._getReauthenticationResolver(r):t._getIdTokenResponse(r)).catch(i=>{throw i.code==="auth/multi-factor-auth-required"?ji._fromErrorAndOperation(r,i,e,n):i})}async function Hy(r,e,t=!1){const n=await as(r,e._linkToIdToken(r.auth,await r.getIdToken()),t);return rr._forOperation(r,"link",n)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ao{constructor(e){this.eventTarget=e,this.handlersMap={},this.boundEventHandler=this.handleEvent.bind(this)}static _getInstance(e){const t=this.receivers.find(s=>s.isListeningto(e));if(t)return t;const n=new ao(e);return this.receivers.push(n),n}isListeningto(e){return this.eventTarget===e}async handleEvent(e){const t=e,{eventId:n,eventType:s,data:i}=t.data,o=this.handlersMap[s];if(!o?.size)return;t.ports[0].postMessage({status:"ack",eventId:n,eventType:s});const l=Array.from(o).map(async d=>d(t.origin,i)),c=await ov(l);t.ports[0].postMessage({status:"done",eventId:n,eventType:s,response:c})}_subscribe(e,t){Object.keys(this.handlersMap).length===0&&this.eventTarget.addEventListener("message",this.boundEventHandler),this.handlersMap[e]||(this.handlersMap[e]=new Set),this.handlersMap[e].add(t)}_unsubscribe(e,t){this.handlersMap[e]&&t&&this.handlersMap[e].delete(t),(!t||this.handlersMap[e].size===0)&&delete this.handlersMap[e],Object.keys(this.handlersMap).length===0&&this.eventTarget.removeEventListener("message",this.boundEventHandler)}}ao.receivers=[];/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zd="firebaseLocalStorageDb",dv=1,Mi="firebaseLocalStorage",ef="fbase_key";class As{constructor(e){this.request=e}toPromise(){return new Promise((e,t)=>{this.request.addEventListener("success",()=>{e(this.request.result)}),this.request.addEventListener("error",()=>{t(this.request.error)})})}}function lo(r,e){return r.transaction([Mi],e?"readwrite":"readonly").objectStore(Mi)}function fv(){const r=indexedDB.deleteDatabase(Zd);return new As(r).toPromise()}function Na(){const r=indexedDB.open(Zd,dv);return new Promise((e,t)=>{r.addEventListener("error",()=>{t(r.error)}),r.addEventListener("upgradeneeded",()=>{const n=r.result;try{n.createObjectStore(Mi,{keyPath:ef})}catch(s){t(s)}}),r.addEventListener("success",async()=>{const n=r.result;n.objectStoreNames.contains(Mi)?e(n):(n.close(),await fv(),e(await Na()))})})}async function Pu(r,e,t){const n=lo(r,!0).put({[ef]:e,value:t});return new As(n).toPromise()}async function mv(r,e){const t=lo(r,!1).get(e),n=await new As(t).toPromise();return n===void 0?null:n.value}function Cu(r,e){const t=lo(r,!0).delete(e);return new As(t).toPromise()}const pv=800,gv=3;class tf{constructor(){this.type="LOCAL",this._shouldAllowMigration=!0,this.listeners={},this.localCache={},this.pollTimer=null,this.pendingWrites=0,this.receiver=null,this.sender=null,this.serviceWorkerReceiverAvailable=!1,this.activeServiceWorker=null,this._workerInitializationPromise=this.initializeServiceWorkerMessaging().then(()=>{},()=>{})}async _openDb(){return this.db?this.db:(this.db=await Na(),this.db)}async _withRetries(e){let t=0;for(;;)try{const n=await this._openDb();return await e(n)}catch(n){if(t++>gv)throw n;this.db&&(this.db.close(),this.db=void 0)}}async initializeServiceWorkerMessaging(){return Xd()?this.initializeReceiver():this.initializeSender()}async initializeReceiver(){this.receiver=ao._getInstance(hv()),this.receiver._subscribe("keyChanged",async(e,t)=>({keyProcessed:(await this._poll()).includes(t.key)})),this.receiver._subscribe("ping",async(e,t)=>["keyChanged"])}async initializeSender(){var e,t;if(this.activeServiceWorker=await cv(),!this.activeServiceWorker)return;this.sender=new av(this.activeServiceWorker);const n=await this.sender._send("ping",{},800);n&&!((e=n[0])===null||e===void 0)&&e.fulfilled&&!((t=n[0])===null||t===void 0)&&t.value.includes("keyChanged")&&(this.serviceWorkerReceiverAvailable=!0)}async notifyServiceWorker(e){if(!(!this.sender||!this.activeServiceWorker||uv()!==this.activeServiceWorker))try{await this.sender._send("keyChanged",{key:e},this.serviceWorkerReceiverAvailable?800:50)}catch{}}async _isAvailable(){try{if(!indexedDB)return!1;const e=await Na();return await Pu(e,Oi,"1"),await Cu(e,Oi),!0}catch{}return!1}async _withPendingWrite(e){this.pendingWrites++;try{await e()}finally{this.pendingWrites--}}async _set(e,t){return this._withPendingWrite(async()=>(await this._withRetries(n=>Pu(n,e,t)),this.localCache[e]=t,this.notifyServiceWorker(e)))}async _get(e){const t=await this._withRetries(n=>mv(n,e));return this.localCache[e]=t,t}async _remove(e){return this._withPendingWrite(async()=>(await this._withRetries(t=>Cu(t,e)),delete this.localCache[e],this.notifyServiceWorker(e)))}async _poll(){const e=await this._withRetries(s=>{const i=lo(s,!1).getAll();return new As(i).toPromise()});if(!e)return[];if(this.pendingWrites!==0)return[];const t=[],n=new Set;if(e.length!==0)for(const{fbase_key:s,value:i}of e)n.add(s),JSON.stringify(this.localCache[s])!==JSON.stringify(i)&&(this.notifyListeners(s,i),t.push(s));for(const s of Object.keys(this.localCache))this.localCache[s]&&!n.has(s)&&(this.notifyListeners(s,null),t.push(s));return t}notifyListeners(e,t){this.localCache[e]=t;const n=this.listeners[e];if(n)for(const s of Array.from(n))s(t)}startPolling(){this.stopPolling(),this.pollTimer=setInterval(async()=>this._poll(),pv)}stopPolling(){this.pollTimer&&(clearInterval(this.pollTimer),this.pollTimer=null)}_addListener(e,t){Object.keys(this.listeners).length===0&&this.startPolling(),this.listeners[e]||(this.listeners[e]=new Set,this._get(e)),this.listeners[e].add(t)}_removeListener(e,t){this.listeners[e]&&(this.listeners[e].delete(t),this.listeners[e].size===0&&delete this.listeners[e]),Object.keys(this.listeners).length===0&&this.stopPolling()}}tf.type="LOCAL";const _v=tf;new Es(3e4,6e4);/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Iv="pendingRedirect",_i=new Map;class Ev extends nf{constructor(e,t,n=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,n),this.eventId=null}async execute(){let e=_i.get(this.auth._key());if(!e){try{const n=await Tv(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(n)}catch(t){e=()=>Promise.reject(t)}_i.set(this.auth._key(),e)}return this.bypassAuthState||_i.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Tv(r,e){const t=Rv(e),n=Sv(r);if(!await n._isAvailable())return!1;const s=await n._get(t)==="true";return await n._remove(t),s}function Av(r,e){_i.set(r._key(),e)}function Sv(r){return xt(r._redirectPersistence)}function Rv(r){return gi(Iv,r.config.apiKey,r.name)}async function Nv(r,e,t=!1){if(yt(r.app))return Promise.reject(zt(r));const n=_r(r),s=yv(n,e),o=await new Ev(n,s,t).execute();return o&&!t&&(delete o.user._redirectEventId,await n._persistUserIfCurrent(o.user),await n._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var vn,sf;(function(){var r;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(x,_){function w(){}w.prototype=_.prototype,x.D=_.prototype,x.prototype=new w,x.prototype.constructor=x,x.C=function(I,b,A){for(var y=Array(arguments.length-2),ee=2;ee<arguments.length;ee++)y[ee-2]=arguments[ee];return _.prototype[b].apply(I,y)}}function t(){this.blockSize=-1}function n(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(n,t),n.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(x,_,w){w||(w=0);var I=Array(16);if(typeof _=="string")for(var b=0;16>b;++b)I[b]=_.charCodeAt(w++)|_.charCodeAt(w++)<<8|_.charCodeAt(w++)<<16|_.charCodeAt(w++)<<24;else for(b=0;16>b;++b)I[b]=_[w++]|_[w++]<<8|_[w++]<<16|_[w++]<<24;_=x.g[0],w=x.g[1],b=x.g[2];var A=x.g[3],y=_+(A^w&(b^A))+I[0]+3614090360&4294967295;_=w+(y<<7&4294967295|y>>>25),y=A+(b^_&(w^b))+I[1]+3905402710&4294967295,A=_+(y<<12&4294967295|y>>>20),y=b+(w^A&(_^w))+I[2]+606105819&4294967295,b=A+(y<<17&4294967295|y>>>15),y=w+(_^b&(A^_))+I[3]+3250441966&4294967295,w=b+(y<<22&4294967295|y>>>10),y=_+(A^w&(b^A))+I[4]+4118548399&4294967295,_=w+(y<<7&4294967295|y>>>25),y=A+(b^_&(w^b))+I[5]+1200080426&4294967295,A=_+(y<<12&4294967295|y>>>20),y=b+(w^A&(_^w))+I[6]+2821735955&4294967295,b=A+(y<<17&4294967295|y>>>15),y=w+(_^b&(A^_))+I[7]+4249261313&4294967295,w=b+(y<<22&4294967295|y>>>10),y=_+(A^w&(b^A))+I[8]+1770035416&4294967295,_=w+(y<<7&4294967295|y>>>25),y=A+(b^_&(w^b))+I[9]+2336552879&4294967295,A=_+(y<<12&4294967295|y>>>20),y=b+(w^A&(_^w))+I[10]+4294925233&4294967295,b=A+(y<<17&4294967295|y>>>15),y=w+(_^b&(A^_))+I[11]+2304563134&4294967295,w=b+(y<<22&4294967295|y>>>10),y=_+(A^w&(b^A))+I[12]+1804603682&4294967295,_=w+(y<<7&4294967295|y>>>25),y=A+(b^_&(w^b))+I[13]+4254626195&4294967295,A=_+(y<<12&4294967295|y>>>20),y=b+(w^A&(_^w))+I[14]+2792965006&4294967295,b=A+(y<<17&4294967295|y>>>15),y=w+(_^b&(A^_))+I[15]+1236535329&4294967295,w=b+(y<<22&4294967295|y>>>10),y=_+(b^A&(w^b))+I[1]+4129170786&4294967295,_=w+(y<<5&4294967295|y>>>27),y=A+(w^b&(_^w))+I[6]+3225465664&4294967295,A=_+(y<<9&4294967295|y>>>23),y=b+(_^w&(A^_))+I[11]+643717713&4294967295,b=A+(y<<14&4294967295|y>>>18),y=w+(A^_&(b^A))+I[0]+3921069994&4294967295,w=b+(y<<20&4294967295|y>>>12),y=_+(b^A&(w^b))+I[5]+3593408605&4294967295,_=w+(y<<5&4294967295|y>>>27),y=A+(w^b&(_^w))+I[10]+38016083&4294967295,A=_+(y<<9&4294967295|y>>>23),y=b+(_^w&(A^_))+I[15]+3634488961&4294967295,b=A+(y<<14&4294967295|y>>>18),y=w+(A^_&(b^A))+I[4]+3889429448&4294967295,w=b+(y<<20&4294967295|y>>>12),y=_+(b^A&(w^b))+I[9]+568446438&4294967295,_=w+(y<<5&4294967295|y>>>27),y=A+(w^b&(_^w))+I[14]+3275163606&4294967295,A=_+(y<<9&4294967295|y>>>23),y=b+(_^w&(A^_))+I[3]+4107603335&4294967295,b=A+(y<<14&4294967295|y>>>18),y=w+(A^_&(b^A))+I[8]+1163531501&4294967295,w=b+(y<<20&4294967295|y>>>12),y=_+(b^A&(w^b))+I[13]+2850285829&4294967295,_=w+(y<<5&4294967295|y>>>27),y=A+(w^b&(_^w))+I[2]+4243563512&4294967295,A=_+(y<<9&4294967295|y>>>23),y=b+(_^w&(A^_))+I[7]+1735328473&4294967295,b=A+(y<<14&4294967295|y>>>18),y=w+(A^_&(b^A))+I[12]+2368359562&4294967295,w=b+(y<<20&4294967295|y>>>12),y=_+(w^b^A)+I[5]+4294588738&4294967295,_=w+(y<<4&4294967295|y>>>28),y=A+(_^w^b)+I[8]+2272392833&4294967295,A=_+(y<<11&4294967295|y>>>21),y=b+(A^_^w)+I[11]+1839030562&4294967295,b=A+(y<<16&4294967295|y>>>16),y=w+(b^A^_)+I[14]+4259657740&4294967295,w=b+(y<<23&4294967295|y>>>9),y=_+(w^b^A)+I[1]+2763975236&4294967295,_=w+(y<<4&4294967295|y>>>28),y=A+(_^w^b)+I[4]+1272893353&4294967295,A=_+(y<<11&4294967295|y>>>21),y=b+(A^_^w)+I[7]+4139469664&4294967295,b=A+(y<<16&4294967295|y>>>16),y=w+(b^A^_)+I[10]+3200236656&4294967295,w=b+(y<<23&4294967295|y>>>9),y=_+(w^b^A)+I[13]+681279174&4294967295,_=w+(y<<4&4294967295|y>>>28),y=A+(_^w^b)+I[0]+3936430074&4294967295,A=_+(y<<11&4294967295|y>>>21),y=b+(A^_^w)+I[3]+3572445317&4294967295,b=A+(y<<16&4294967295|y>>>16),y=w+(b^A^_)+I[6]+76029189&4294967295,w=b+(y<<23&4294967295|y>>>9),y=_+(w^b^A)+I[9]+3654602809&4294967295,_=w+(y<<4&4294967295|y>>>28),y=A+(_^w^b)+I[12]+3873151461&4294967295,A=_+(y<<11&4294967295|y>>>21),y=b+(A^_^w)+I[15]+530742520&4294967295,b=A+(y<<16&4294967295|y>>>16),y=w+(b^A^_)+I[2]+3299628645&4294967295,w=b+(y<<23&4294967295|y>>>9),y=_+(b^(w|~A))+I[0]+4096336452&4294967295,_=w+(y<<6&4294967295|y>>>26),y=A+(w^(_|~b))+I[7]+1126891415&4294967295,A=_+(y<<10&4294967295|y>>>22),y=b+(_^(A|~w))+I[14]+2878612391&4294967295,b=A+(y<<15&4294967295|y>>>17),y=w+(A^(b|~_))+I[5]+4237533241&4294967295,w=b+(y<<21&4294967295|y>>>11),y=_+(b^(w|~A))+I[12]+1700485571&4294967295,_=w+(y<<6&4294967295|y>>>26),y=A+(w^(_|~b))+I[3]+2399980690&4294967295,A=_+(y<<10&4294967295|y>>>22),y=b+(_^(A|~w))+I[10]+4293915773&4294967295,b=A+(y<<15&4294967295|y>>>17),y=w+(A^(b|~_))+I[1]+2240044497&4294967295,w=b+(y<<21&4294967295|y>>>11),y=_+(b^(w|~A))+I[8]+1873313359&4294967295,_=w+(y<<6&4294967295|y>>>26),y=A+(w^(_|~b))+I[15]+4264355552&4294967295,A=_+(y<<10&4294967295|y>>>22),y=b+(_^(A|~w))+I[6]+2734768916&4294967295,b=A+(y<<15&4294967295|y>>>17),y=w+(A^(b|~_))+I[13]+1309151649&4294967295,w=b+(y<<21&4294967295|y>>>11),y=_+(b^(w|~A))+I[4]+4149444226&4294967295,_=w+(y<<6&4294967295|y>>>26),y=A+(w^(_|~b))+I[11]+3174756917&4294967295,A=_+(y<<10&4294967295|y>>>22),y=b+(_^(A|~w))+I[2]+718787259&4294967295,b=A+(y<<15&4294967295|y>>>17),y=w+(A^(b|~_))+I[9]+3951481745&4294967295,x.g[0]=x.g[0]+_&4294967295,x.g[1]=x.g[1]+(b+(y<<21&4294967295|y>>>11))&4294967295,x.g[2]=x.g[2]+b&4294967295,x.g[3]=x.g[3]+A&4294967295}n.prototype.u=function(x,_){_===void 0&&(_=x.length);for(var w=_-this.blockSize,I=this.B,b=this.h,A=0;A<_;){if(b==0)for(;A<=w;)s(this,x,A),A+=this.blockSize;if(typeof x=="string"){for(;A<_;)if(I[b++]=x.charCodeAt(A++),b==this.blockSize){s(this,I),b=0;break}}else for(;A<_;)if(I[b++]=x[A++],b==this.blockSize){s(this,I),b=0;break}}this.h=b,this.o+=_},n.prototype.v=function(){var x=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);x[0]=128;for(var _=1;_<x.length-8;++_)x[_]=0;var w=8*this.o;for(_=x.length-8;_<x.length;++_)x[_]=w&255,w/=256;for(this.u(x),x=Array(16),_=w=0;4>_;++_)for(var I=0;32>I;I+=8)x[w++]=this.g[_]>>>I&255;return x};function i(x,_){var w=l;return Object.prototype.hasOwnProperty.call(w,x)?w[x]:w[x]=_(x)}function o(x,_){this.h=_;for(var w=[],I=!0,b=x.length-1;0<=b;b--){var A=x[b]|0;I&&A==_||(w[b]=A,I=!1)}this.g=w}var l={};function c(x){return-128<=x&&128>x?i(x,function(_){return new o([_|0],0>_?-1:0)}):new o([x|0],0>x?-1:0)}function d(x){if(isNaN(x)||!isFinite(x))return p;if(0>x)return C(d(-x));for(var _=[],w=1,I=0;x>=w;I++)_[I]=x/w|0,w*=4294967296;return new o(_,0)}function m(x,_){if(x.length==0)throw Error("number format error: empty string");if(_=_||10,2>_||36<_)throw Error("radix out of range: "+_);if(x.charAt(0)=="-")return C(m(x.substring(1),_));if(0<=x.indexOf("-"))throw Error('number format error: interior "-" character');for(var w=d(Math.pow(_,8)),I=p,b=0;b<x.length;b+=8){var A=Math.min(8,x.length-b),y=parseInt(x.substring(b,b+A),_);8>A?(A=d(Math.pow(_,A)),I=I.j(A).add(d(y))):(I=I.j(w),I=I.add(d(y)))}return I}var p=c(0),v=c(1),E=c(16777216);r=o.prototype,r.m=function(){if(D(this))return-C(this).m();for(var x=0,_=1,w=0;w<this.g.length;w++){var I=this.i(w);x+=(0<=I?I:4294967296+I)*_,_*=4294967296}return x},r.toString=function(x){if(x=x||10,2>x||36<x)throw Error("radix out of range: "+x);if(T(this))return"0";if(D(this))return"-"+C(this).toString(x);for(var _=d(Math.pow(x,6)),w=this,I="";;){var b=$(w,_).g;w=F(w,b.j(_));var A=((0<w.g.length?w.g[0]:w.h)>>>0).toString(x);if(w=b,T(w))return A+I;for(;6>A.length;)A="0"+A;I=A+I}},r.i=function(x){return 0>x?0:x<this.g.length?this.g[x]:this.h};function T(x){if(x.h!=0)return!1;for(var _=0;_<x.g.length;_++)if(x.g[_]!=0)return!1;return!0}function D(x){return x.h==-1}r.l=function(x){return x=F(this,x),D(x)?-1:T(x)?0:1};function C(x){for(var _=x.g.length,w=[],I=0;I<_;I++)w[I]=~x.g[I];return new o(w,~x.h).add(v)}r.abs=function(){return D(this)?C(this):this},r.add=function(x){for(var _=Math.max(this.g.length,x.g.length),w=[],I=0,b=0;b<=_;b++){var A=I+(this.i(b)&65535)+(x.i(b)&65535),y=(A>>>16)+(this.i(b)>>>16)+(x.i(b)>>>16);I=y>>>16,A&=65535,y&=65535,w[b]=y<<16|A}return new o(w,w[w.length-1]&-2147483648?-1:0)};function F(x,_){return x.add(C(_))}r.j=function(x){if(T(this)||T(x))return p;if(D(this))return D(x)?C(this).j(C(x)):C(C(this).j(x));if(D(x))return C(this.j(C(x)));if(0>this.l(E)&&0>x.l(E))return d(this.m()*x.m());for(var _=this.g.length+x.g.length,w=[],I=0;I<2*_;I++)w[I]=0;for(I=0;I<this.g.length;I++)for(var b=0;b<x.g.length;b++){var A=this.i(I)>>>16,y=this.i(I)&65535,ee=x.i(b)>>>16,se=x.i(b)&65535;w[2*I+2*b]+=y*se,O(w,2*I+2*b),w[2*I+2*b+1]+=A*se,O(w,2*I+2*b+1),w[2*I+2*b+1]+=y*ee,O(w,2*I+2*b+1),w[2*I+2*b+2]+=A*ee,O(w,2*I+2*b+2)}for(I=0;I<_;I++)w[I]=w[2*I+1]<<16|w[2*I];for(I=_;I<2*_;I++)w[I]=0;return new o(w,0)};function O(x,_){for(;(x[_]&65535)!=x[_];)x[_+1]+=x[_]>>>16,x[_]&=65535,_++}function L(x,_){this.g=x,this.h=_}function $(x,_){if(T(_))throw Error("division by zero");if(T(x))return new L(p,p);if(D(x))return _=$(C(x),_),new L(C(_.g),C(_.h));if(D(_))return _=$(x,C(_)),new L(C(_.g),_.h);if(30<x.g.length){if(D(x)||D(_))throw Error("slowDivide_ only works with positive integers.");for(var w=v,I=_;0>=I.l(x);)w=P(w),I=P(I);var b=R(w,1),A=R(I,1);for(I=R(I,2),w=R(w,2);!T(I);){var y=A.add(I);0>=y.l(x)&&(b=b.add(w),A=y),I=R(I,1),w=R(w,1)}return _=F(x,b.j(_)),new L(b,_)}for(b=p;0<=x.l(_);){for(w=Math.max(1,Math.floor(x.m()/_.m())),I=Math.ceil(Math.log(w)/Math.LN2),I=48>=I?1:Math.pow(2,I-48),A=d(w),y=A.j(_);D(y)||0<y.l(x);)w-=I,A=d(w),y=A.j(_);T(A)&&(A=v),b=b.add(A),x=F(x,y)}return new L(b,x)}r.A=function(x){return $(this,x).h},r.and=function(x){for(var _=Math.max(this.g.length,x.g.length),w=[],I=0;I<_;I++)w[I]=this.i(I)&x.i(I);return new o(w,this.h&x.h)},r.or=function(x){for(var _=Math.max(this.g.length,x.g.length),w=[],I=0;I<_;I++)w[I]=this.i(I)|x.i(I);return new o(w,this.h|x.h)},r.xor=function(x){for(var _=Math.max(this.g.length,x.g.length),w=[],I=0;I<_;I++)w[I]=this.i(I)^x.i(I);return new o(w,this.h^x.h)};function P(x){for(var _=x.g.length+1,w=[],I=0;I<_;I++)w[I]=x.i(I)<<1|x.i(I-1)>>>31;return new o(w,x.h)}function R(x,_){var w=_>>5;_%=32;for(var I=x.g.length-w,b=[],A=0;A<I;A++)b[A]=0<_?x.i(A+w)>>>_|x.i(A+w+1)<<32-_:x.i(A+w);return new o(b,x.h)}n.prototype.digest=n.prototype.v,n.prototype.reset=n.prototype.s,n.prototype.update=n.prototype.u,sf=n,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=d,o.fromString=m,vn=o}).apply(typeof Fu<"u"?Fu:typeof self<"u"?self:typeof window<"u"?window:{});var si=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var of,Kr,af,vi,Pa,lf,cf,uf;(function(){var r,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(a,h,f){return a==Array.prototype||a==Object.prototype||(a[h]=f.value),a};function t(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof si=="object"&&si];for(var h=0;h<a.length;++h){var f=a[h];if(f&&f.Math==Math)return f}throw Error("Cannot find global object")}var n=t(this);function s(a,h){if(h)e:{var f=n;a=a.split(".");for(var g=0;g<a.length-1;g++){var S=a[g];if(!(S in f))break e;f=f[S]}a=a[a.length-1],g=f[a],h=h(g),h!=g&&h!=null&&e(f,a,{configurable:!0,writable:!0,value:h})}}function i(a,h){a instanceof String&&(a+="");var f=0,g=!1,S={next:function(){if(!g&&f<a.length){var k=f++;return{value:h(k,a[k]),done:!1}}return g=!0,{done:!0,value:void 0}}};return S[Symbol.iterator]=function(){return S},S}s("Array.prototype.values",function(a){return a||function(){return i(this,function(h,f){return f})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},l=this||self;function c(a){var h=typeof a;return h=h!="object"?h:a?Array.isArray(a)?"array":h:"null",h=="array"||h=="object"&&typeof a.length=="number"}function d(a){var h=typeof a;return h=="object"&&a!=null||h=="function"}function m(a,h,f){return a.call.apply(a.bind,arguments)}function p(a,h,f){if(!a)throw Error();if(2<arguments.length){var g=Array.prototype.slice.call(arguments,2);return function(){var S=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(S,g),a.apply(h,S)}}return function(){return a.apply(h,arguments)}}function v(a,h,f){return v=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?m:p,v.apply(null,arguments)}function E(a,h){var f=Array.prototype.slice.call(arguments,1);return function(){var g=f.slice();return g.push.apply(g,arguments),a.apply(this,g)}}function T(a,h){function f(){}f.prototype=h.prototype,a.aa=h.prototype,a.prototype=new f,a.prototype.constructor=a,a.Qb=function(g,S,k){for(var U=Array(arguments.length-2),he=2;he<arguments.length;he++)U[he-2]=arguments[he];return h.prototype[S].apply(g,U)}}function D(a){const h=a.length;if(0<h){const f=Array(h);for(let g=0;g<h;g++)f[g]=a[g];return f}return[]}function C(a,h){for(let f=1;f<arguments.length;f++){const g=arguments[f];if(c(g)){const S=a.length||0,k=g.length||0;a.length=S+k;for(let U=0;U<k;U++)a[S+U]=g[U]}else a.push(g)}}class F{constructor(h,f){this.i=h,this.j=f,this.h=0,this.g=null}get(){let h;return 0<this.h?(this.h--,h=this.g,this.g=h.next,h.next=null):h=this.i(),h}}function O(a){return/^[\s\xa0]*$/.test(a)}function L(){var a=l.navigator;return a&&(a=a.userAgent)?a:""}function $(a){return $[" "](a),a}$[" "]=function(){};var P=L().indexOf("Gecko")!=-1&&!(L().toLowerCase().indexOf("webkit")!=-1&&L().indexOf("Edge")==-1)&&!(L().indexOf("Trident")!=-1||L().indexOf("MSIE")!=-1)&&L().indexOf("Edge")==-1;function R(a,h,f){for(const g in a)h.call(f,a[g],g,a)}function x(a,h){for(const f in a)h.call(void 0,a[f],f,a)}function _(a){const h={};for(const f in a)h[f]=a[f];return h}const w="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function I(a,h){let f,g;for(let S=1;S<arguments.length;S++){g=arguments[S];for(f in g)a[f]=g[f];for(let k=0;k<w.length;k++)f=w[k],Object.prototype.hasOwnProperty.call(g,f)&&(a[f]=g[f])}}function b(a){var h=1;a=a.split(":");const f=[];for(;0<h&&a.length;)f.push(a.shift()),h--;return a.length&&f.push(a.join(":")),f}function A(a){l.setTimeout(()=>{throw a},0)}function y(){var a=oe;let h=null;return a.g&&(h=a.g,a.g=a.g.next,a.g||(a.h=null),h.next=null),h}class ee{constructor(){this.h=this.g=null}add(h,f){const g=se.get();g.set(h,f),this.h?this.h.next=g:this.g=g,this.h=g}}var se=new F(()=>new z,a=>a.reset());class z{constructor(){this.next=this.g=this.h=null}set(h,f){this.h=h,this.g=f,this.next=null}reset(){this.next=this.g=this.h=null}}let H,X=!1,oe=new ee,Je=()=>{const a=l.Promise.resolve(void 0);H=()=>{a.then(On)}};var On=()=>{for(var a;a=y();){try{a.h.call(a.g)}catch(f){A(f)}var h=se;h.j(a),100>h.h&&(h.h++,a.next=h.g,h.g=a)}X=!1};function et(){this.s=this.s,this.C=this.C}et.prototype.s=!1,et.prototype.ma=function(){this.s||(this.s=!0,this.N())},et.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function Ee(a,h){this.type=a,this.g=this.target=h,this.defaultPrevented=!1}Ee.prototype.h=function(){this.defaultPrevented=!0};var Ls=function(){if(!l.addEventListener||!Object.defineProperty)return!1;var a=!1,h=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const f=()=>{};l.addEventListener("test",f,h),l.removeEventListener("test",f,h)}catch{}return a}();function Nt(a,h){if(Ee.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a){var f=this.type=a.type,g=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;if(this.target=a.target||a.srcElement,this.g=h,h=a.relatedTarget){if(P){e:{try{$(h.nodeName);var S=!0;break e}catch{}S=!1}S||(h=null)}}else f=="mouseover"?h=a.fromElement:f=="mouseout"&&(h=a.toElement);this.relatedTarget=h,g?(this.clientX=g.clientX!==void 0?g.clientX:g.pageX,this.clientY=g.clientY!==void 0?g.clientY:g.pageY,this.screenX=g.screenX||0,this.screenY=g.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=typeof a.pointerType=="string"?a.pointerType:Fs[a.pointerType]||"",this.state=a.state,this.i=a,a.defaultPrevented&&Nt.aa.h.call(this)}}T(Nt,Ee);var Fs={2:"touch",3:"pen",4:"mouse"};Nt.prototype.h=function(){Nt.aa.h.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var nn="closure_listenable_"+(1e6*Math.random()|0),ko=0;function Us(a,h,f,g,S){this.listener=a,this.proxy=null,this.src=h,this.type=f,this.capture=!!g,this.ha=S,this.key=++ko,this.da=this.fa=!1}function rn(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function sn(a){this.src=a,this.g={},this.h=0}sn.prototype.add=function(a,h,f,g,S){var k=a.toString();a=this.g[k],a||(a=this.g[k]=[],this.h++);var U=ue(a,h,g,S);return-1<U?(h=a[U],f||(h.fa=!1)):(h=new Us(h,this.src,k,!!g,S),h.fa=f,a.push(h)),h};function Mn(a,h){var f=h.type;if(f in a.g){var g=a.g[f],S=Array.prototype.indexOf.call(g,h,void 0),k;(k=0<=S)&&Array.prototype.splice.call(g,S,1),k&&(rn(h),a.g[f].length==0&&(delete a.g[f],a.h--))}}function ue(a,h,f,g){for(var S=0;S<a.length;++S){var k=a[S];if(!k.da&&k.listener==h&&k.capture==!!f&&k.ha==g)return S}return-1}var Ir="closure_lm_"+(1e6*Math.random()|0),Ln={};function lc(a,h,f,g,S){if(Array.isArray(h)){for(var k=0;k<h.length;k++)lc(a,h[k],f,g,S);return null}return f=hc(f),a&&a[nn]?a.K(h,f,d(g)?!!g.capture:!1,S):Ep(a,h,f,!1,g,S)}function Ep(a,h,f,g,S,k){if(!h)throw Error("Invalid event type");var U=d(S)?!!S.capture:!!S,he=Vo(a);if(he||(a[Ir]=he=new sn(a)),f=he.add(h,f,g,U,k),f.proxy)return f;if(g=Tp(),f.proxy=g,g.src=a,g.listener=f,a.addEventListener)Ls||(S=U),S===void 0&&(S=!1),a.addEventListener(h.toString(),g,S);else if(a.attachEvent)a.attachEvent(uc(h.toString()),g);else if(a.addListener&&a.removeListener)a.addListener(g);else throw Error("addEventListener and attachEvent are unavailable.");return f}function Tp(){function a(f){return h.call(a.src,a.listener,f)}const h=Ap;return a}function cc(a,h,f,g,S){if(Array.isArray(h))for(var k=0;k<h.length;k++)cc(a,h[k],f,g,S);else g=d(g)?!!g.capture:!!g,f=hc(f),a&&a[nn]?(a=a.i,h=String(h).toString(),h in a.g&&(k=a.g[h],f=ue(k,f,g,S),-1<f&&(rn(k[f]),Array.prototype.splice.call(k,f,1),k.length==0&&(delete a.g[h],a.h--)))):a&&(a=Vo(a))&&(h=a.g[h.toString()],a=-1,h&&(a=ue(h,f,g,S)),(f=-1<a?h[a]:null)&&Do(f))}function Do(a){if(typeof a!="number"&&a&&!a.da){var h=a.src;if(h&&h[nn])Mn(h.i,a);else{var f=a.type,g=a.proxy;h.removeEventListener?h.removeEventListener(f,g,a.capture):h.detachEvent?h.detachEvent(uc(f),g):h.addListener&&h.removeListener&&h.removeListener(g),(f=Vo(h))?(Mn(f,a),f.h==0&&(f.src=null,h[Ir]=null)):rn(a)}}}function uc(a){return a in Ln?Ln[a]:Ln[a]="on"+a}function Ap(a,h){if(a.da)a=!0;else{h=new Nt(h,this);var f=a.listener,g=a.ha||a.src;a.fa&&Do(a),a=f.call(g,h)}return a}function Vo(a){return a=a[Ir],a instanceof sn?a:null}var jo="__closure_events_fn_"+(1e9*Math.random()>>>0);function hc(a){return typeof a=="function"?a:(a[jo]||(a[jo]=function(h){return a.handleEvent(h)}),a[jo])}function Pe(){et.call(this),this.i=new sn(this),this.M=this,this.F=null}T(Pe,et),Pe.prototype[nn]=!0,Pe.prototype.removeEventListener=function(a,h,f,g){cc(this,a,h,f,g)};function Le(a,h){var f,g=a.F;if(g)for(f=[];g;g=g.F)f.push(g);if(a=a.M,g=h.type||h,typeof h=="string")h=new Ee(h,a);else if(h instanceof Ee)h.target=h.target||a;else{var S=h;h=new Ee(g,a),I(h,S)}if(S=!0,f)for(var k=f.length-1;0<=k;k--){var U=h.g=f[k];S=Bs(U,g,!0,h)&&S}if(U=h.g=a,S=Bs(U,g,!0,h)&&S,S=Bs(U,g,!1,h)&&S,f)for(k=0;k<f.length;k++)U=h.g=f[k],S=Bs(U,g,!1,h)&&S}Pe.prototype.N=function(){if(Pe.aa.N.call(this),this.i){var a=this.i,h;for(h in a.g){for(var f=a.g[h],g=0;g<f.length;g++)rn(f[g]);delete a.g[h],a.h--}}this.F=null},Pe.prototype.K=function(a,h,f,g){return this.i.add(String(a),h,!1,f,g)},Pe.prototype.L=function(a,h,f,g){return this.i.add(String(a),h,!0,f,g)};function Bs(a,h,f,g){if(h=a.i.g[String(h)],!h)return!0;h=h.concat();for(var S=!0,k=0;k<h.length;++k){var U=h[k];if(U&&!U.da&&U.capture==f){var he=U.listener,Re=U.ha||U.src;U.fa&&Mn(a.i,U),S=he.call(Re,g)!==!1&&S}}return S&&!g.defaultPrevented}function dc(a,h,f){if(typeof a=="function")f&&(a=v(a,f));else if(a&&typeof a.handleEvent=="function")a=v(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(h)?-1:l.setTimeout(a,h||0)}function fc(a){a.g=dc(()=>{a.g=null,a.i&&(a.i=!1,fc(a))},a.l);const h=a.h;a.h=null,a.m.apply(null,h)}class Sp extends et{constructor(h,f){super(),this.m=h,this.l=f,this.h=null,this.i=!1,this.g=null}j(h){this.h=arguments,this.g?this.i=!0:fc(this)}N(){super.N(),this.g&&(l.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Er(a){et.call(this),this.h=a,this.g={}}T(Er,et);var mc=[];function pc(a){R(a.g,function(h,f){this.g.hasOwnProperty(f)&&Do(h)},a),a.g={}}Er.prototype.N=function(){Er.aa.N.call(this),pc(this)},Er.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Oo=l.JSON.stringify,Rp=l.JSON.parse,Np=class{stringify(a){return l.JSON.stringify(a,void 0)}parse(a){return l.JSON.parse(a,void 0)}};function Mo(){}Mo.prototype.h=null;function gc(a){return a.h||(a.h=a.i())}function _c(){}var Tr={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function Lo(){Ee.call(this,"d")}T(Lo,Ee);function Fo(){Ee.call(this,"c")}T(Fo,Ee);var on={},yc=null;function qs(){return yc=yc||new Pe}on.La="serverreachability";function vc(a){Ee.call(this,on.La,a)}T(vc,Ee);function Ar(a){const h=qs();Le(h,new vc(h))}on.STAT_EVENT="statevent";function bc(a,h){Ee.call(this,on.STAT_EVENT,a),this.stat=h}T(bc,Ee);function Fe(a){const h=qs();Le(h,new bc(h,a))}on.Ma="timingevent";function xc(a,h){Ee.call(this,on.Ma,a),this.size=h}T(xc,Ee);function Sr(a,h){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return l.setTimeout(function(){a()},h)}function Rr(){this.g=!0}Rr.prototype.xa=function(){this.g=!1};function Pp(a,h,f,g,S,k){a.info(function(){if(a.g)if(k)for(var U="",he=k.split("&"),Re=0;Re<he.length;Re++){var ie=he[Re].split("=");if(1<ie.length){var Ce=ie[0];ie=ie[1];var ke=Ce.split("_");U=2<=ke.length&&ke[1]=="type"?U+(Ce+"="+ie+"&"):U+(Ce+"=redacted&")}}else U=null;else U=k;return"XMLHTTP REQ ("+g+") [attempt "+S+"]: "+h+`
`+f+`
`+U})}function Cp(a,h,f,g,S,k,U){a.info(function(){return"XMLHTTP RESP ("+g+") [ attempt "+S+"]: "+h+`
`+f+`
`+k+" "+U})}function Fn(a,h,f,g){a.info(function(){return"XMLHTTP TEXT ("+h+"): "+Dp(a,f)+(g?" "+g:"")})}function kp(a,h){a.info(function(){return"TIMEOUT: "+h})}Rr.prototype.info=function(){};function Dp(a,h){if(!a.g)return h;if(!h)return null;try{var f=JSON.parse(h);if(f){for(a=0;a<f.length;a++)if(Array.isArray(f[a])){var g=f[a];if(!(2>g.length)){var S=g[1];if(Array.isArray(S)&&!(1>S.length)){var k=S[0];if(k!="noop"&&k!="stop"&&k!="close")for(var U=1;U<S.length;U++)S[U]=""}}}}return Oo(f)}catch{return h}}var $s={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},wc={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},Uo;function zs(){}T(zs,Mo),zs.prototype.g=function(){return new XMLHttpRequest},zs.prototype.i=function(){return{}},Uo=new zs;function Pt(a,h,f,g){this.j=a,this.i=h,this.l=f,this.R=g||1,this.U=new Er(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Ic}function Ic(){this.i=null,this.g="",this.h=!1}var Ec={},Bo={};function qo(a,h,f){a.L=1,a.v=Hs(gt(h)),a.m=f,a.P=!0,Tc(a,null)}function Tc(a,h){a.F=Date.now(),Ks(a),a.A=gt(a.v);var f=a.A,g=a.R;Array.isArray(g)||(g=[String(g)]),Fc(f.i,"t",g),a.C=0,f=a.j.J,a.h=new Ic,a.g=ru(a.j,f?h:null,!a.m),0<a.O&&(a.M=new Sp(v(a.Y,a,a.g),a.O)),h=a.U,f=a.g,g=a.ca;var S="readystatechange";Array.isArray(S)||(S&&(mc[0]=S.toString()),S=mc);for(var k=0;k<S.length;k++){var U=lc(f,S[k],g||h.handleEvent,!1,h.h||h);if(!U)break;h.g[U.key]=U}h=a.H?_(a.H):{},a.m?(a.u||(a.u="POST"),h["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.A,a.u,a.m,h)):(a.u="GET",a.g.ea(a.A,a.u,null,h)),Ar(),Pp(a.i,a.u,a.A,a.l,a.R,a.m)}Pt.prototype.ca=function(a){a=a.target;const h=this.M;h&&_t(a)==3?h.j():this.Y(a)},Pt.prototype.Y=function(a){try{if(a==this.g)e:{const ke=_t(this.g);var h=this.g.Ba();const qn=this.g.Z();if(!(3>ke)&&(ke!=3||this.g&&(this.h.h||this.g.oa()||Gc(this.g)))){this.J||ke!=4||h==7||(h==8||0>=qn?Ar(3):Ar(2)),$o(this);var f=this.g.Z();this.X=f;t:if(Ac(this)){var g=Gc(this.g);a="";var S=g.length,k=_t(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){an(this),Nr(this);var U="";break t}this.h.i=new l.TextDecoder}for(h=0;h<S;h++)this.h.h=!0,a+=this.h.i.decode(g[h],{stream:!(k&&h==S-1)});g.length=0,this.h.g+=a,this.C=0,U=this.h.g}else U=this.g.oa();if(this.o=f==200,Cp(this.i,this.u,this.A,this.l,this.R,ke,f),this.o){if(this.T&&!this.K){t:{if(this.g){var he,Re=this.g;if((he=Re.g?Re.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!O(he)){var ie=he;break t}}ie=null}if(f=ie)Fn(this.i,this.l,f,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,zo(this,f);else{this.o=!1,this.s=3,Fe(12),an(this),Nr(this);break e}}if(this.P){f=!0;let tt;for(;!this.J&&this.C<U.length;)if(tt=Vp(this,U),tt==Bo){ke==4&&(this.s=4,Fe(14),f=!1),Fn(this.i,this.l,null,"[Incomplete Response]");break}else if(tt==Ec){this.s=4,Fe(15),Fn(this.i,this.l,U,"[Invalid Chunk]"),f=!1;break}else Fn(this.i,this.l,tt,null),zo(this,tt);if(Ac(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),ke!=4||U.length!=0||this.h.h||(this.s=1,Fe(16),f=!1),this.o=this.o&&f,!f)Fn(this.i,this.l,U,"[Invalid Chunked Response]"),an(this),Nr(this);else if(0<U.length&&!this.W){this.W=!0;var Ce=this.j;Ce.g==this&&Ce.ba&&!Ce.M&&(Ce.j.info("Great, no buffering proxy detected. Bytes received: "+U.length),Jo(Ce),Ce.M=!0,Fe(11))}}else Fn(this.i,this.l,U,null),zo(this,U);ke==4&&an(this),this.o&&!this.J&&(ke==4?Zc(this.j,this):(this.o=!1,Ks(this)))}else Yp(this.g),f==400&&0<U.indexOf("Unknown SID")?(this.s=3,Fe(12)):(this.s=0,Fe(13)),an(this),Nr(this)}}}catch{}finally{}};function Ac(a){return a.g?a.u=="GET"&&a.L!=2&&a.j.Ca:!1}function Vp(a,h){var f=a.C,g=h.indexOf(`
`,f);return g==-1?Bo:(f=Number(h.substring(f,g)),isNaN(f)?Ec:(g+=1,g+f>h.length?Bo:(h=h.slice(g,g+f),a.C=g+f,h)))}Pt.prototype.cancel=function(){this.J=!0,an(this)};function Ks(a){a.S=Date.now()+a.I,Sc(a,a.I)}function Sc(a,h){if(a.B!=null)throw Error("WatchDog timer not null");a.B=Sr(v(a.ba,a),h)}function $o(a){a.B&&(l.clearTimeout(a.B),a.B=null)}Pt.prototype.ba=function(){this.B=null;const a=Date.now();0<=a-this.S?(kp(this.i,this.A),this.L!=2&&(Ar(),Fe(17)),an(this),this.s=2,Nr(this)):Sc(this,this.S-a)};function Nr(a){a.j.G==0||a.J||Zc(a.j,a)}function an(a){$o(a);var h=a.M;h&&typeof h.ma=="function"&&h.ma(),a.M=null,pc(a.U),a.g&&(h=a.g,a.g=null,h.abort(),h.ma())}function zo(a,h){try{var f=a.j;if(f.G!=0&&(f.g==a||Ko(f.h,a))){if(!a.K&&Ko(f.h,a)&&f.G==3){try{var g=f.Da.g.parse(h)}catch{g=null}if(Array.isArray(g)&&g.length==3){var S=g;if(S[0]==0){e:if(!f.u){if(f.g)if(f.g.F+3e3<a.F)ei(f),Xs(f);else break e;Qo(f),Fe(18)}}else f.za=S[1],0<f.za-f.T&&37500>S[2]&&f.F&&f.v==0&&!f.C&&(f.C=Sr(v(f.Za,f),6e3));if(1>=Pc(f.h)&&f.ca){try{f.ca()}catch{}f.ca=void 0}}else cn(f,11)}else if((a.K||f.g==a)&&ei(f),!O(h))for(S=f.Da.g.parse(h),h=0;h<S.length;h++){let ie=S[h];if(f.T=ie[0],ie=ie[1],f.G==2)if(ie[0]=="c"){f.K=ie[1],f.ia=ie[2];const Ce=ie[3];Ce!=null&&(f.la=Ce,f.j.info("VER="+f.la));const ke=ie[4];ke!=null&&(f.Aa=ke,f.j.info("SVER="+f.Aa));const qn=ie[5];qn!=null&&typeof qn=="number"&&0<qn&&(g=1.5*qn,f.L=g,f.j.info("backChannelRequestTimeoutMs_="+g)),g=f;const tt=a.g;if(tt){const ni=tt.g?tt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(ni){var k=g.h;k.g||ni.indexOf("spdy")==-1&&ni.indexOf("quic")==-1&&ni.indexOf("h2")==-1||(k.j=k.l,k.g=new Set,k.h&&(Go(k,k.h),k.h=null))}if(g.D){const Yo=tt.g?tt.g.getResponseHeader("X-HTTP-Session-Id"):null;Yo&&(g.ya=Yo,fe(g.I,g.D,Yo))}}f.G=3,f.l&&f.l.ua(),f.ba&&(f.R=Date.now()-a.F,f.j.info("Handshake RTT: "+f.R+"ms")),g=f;var U=a;if(g.qa=nu(g,g.J?g.ia:null,g.W),U.K){Cc(g.h,U);var he=U,Re=g.L;Re&&(he.I=Re),he.B&&($o(he),Ks(he)),g.g=U}else Yc(g);0<f.i.length&&Zs(f)}else ie[0]!="stop"&&ie[0]!="close"||cn(f,7);else f.G==3&&(ie[0]=="stop"||ie[0]=="close"?ie[0]=="stop"?cn(f,7):Ho(f):ie[0]!="noop"&&f.l&&f.l.ta(ie),f.v=0)}}Ar(4)}catch{}}var jp=class{constructor(a,h){this.g=a,this.map=h}};function Rc(a){this.l=a||10,l.PerformanceNavigationTiming?(a=l.performance.getEntriesByType("navigation"),a=0<a.length&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(l.chrome&&l.chrome.loadTimes&&l.chrome.loadTimes()&&l.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Nc(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function Pc(a){return a.h?1:a.g?a.g.size:0}function Ko(a,h){return a.h?a.h==h:a.g?a.g.has(h):!1}function Go(a,h){a.g?a.g.add(h):a.h=h}function Cc(a,h){a.h&&a.h==h?a.h=null:a.g&&a.g.has(h)&&a.g.delete(h)}Rc.prototype.cancel=function(){if(this.i=kc(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function kc(a){if(a.h!=null)return a.i.concat(a.h.D);if(a.g!=null&&a.g.size!==0){let h=a.i;for(const f of a.g.values())h=h.concat(f.D);return h}return D(a.i)}function Op(a){if(a.V&&typeof a.V=="function")return a.V();if(typeof Map<"u"&&a instanceof Map||typeof Set<"u"&&a instanceof Set)return Array.from(a.values());if(typeof a=="string")return a.split("");if(c(a)){for(var h=[],f=a.length,g=0;g<f;g++)h.push(a[g]);return h}h=[],f=0;for(g in a)h[f++]=a[g];return h}function Mp(a){if(a.na&&typeof a.na=="function")return a.na();if(!a.V||typeof a.V!="function"){if(typeof Map<"u"&&a instanceof Map)return Array.from(a.keys());if(!(typeof Set<"u"&&a instanceof Set)){if(c(a)||typeof a=="string"){var h=[];a=a.length;for(var f=0;f<a;f++)h.push(f);return h}h=[],f=0;for(const g in a)h[f++]=g;return h}}}function Dc(a,h){if(a.forEach&&typeof a.forEach=="function")a.forEach(h,void 0);else if(c(a)||typeof a=="string")Array.prototype.forEach.call(a,h,void 0);else for(var f=Mp(a),g=Op(a),S=g.length,k=0;k<S;k++)h.call(void 0,g[k],f&&f[k],a)}var Vc=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Lp(a,h){if(a){a=a.split("&");for(var f=0;f<a.length;f++){var g=a[f].indexOf("="),S=null;if(0<=g){var k=a[f].substring(0,g);S=a[f].substring(g+1)}else k=a[f];h(k,S?decodeURIComponent(S.replace(/\+/g," ")):"")}}}function ln(a){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,a instanceof ln){this.h=a.h,Gs(this,a.j),this.o=a.o,this.g=a.g,Ws(this,a.s),this.l=a.l;var h=a.i,f=new kr;f.i=h.i,h.g&&(f.g=new Map(h.g),f.h=h.h),jc(this,f),this.m=a.m}else a&&(h=String(a).match(Vc))?(this.h=!1,Gs(this,h[1]||"",!0),this.o=Pr(h[2]||""),this.g=Pr(h[3]||"",!0),Ws(this,h[4]),this.l=Pr(h[5]||"",!0),jc(this,h[6]||"",!0),this.m=Pr(h[7]||"")):(this.h=!1,this.i=new kr(null,this.h))}ln.prototype.toString=function(){var a=[],h=this.j;h&&a.push(Cr(h,Oc,!0),":");var f=this.g;return(f||h=="file")&&(a.push("//"),(h=this.o)&&a.push(Cr(h,Oc,!0),"@"),a.push(encodeURIComponent(String(f)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),f=this.s,f!=null&&a.push(":",String(f))),(f=this.l)&&(this.g&&f.charAt(0)!="/"&&a.push("/"),a.push(Cr(f,f.charAt(0)=="/"?Bp:Up,!0))),(f=this.i.toString())&&a.push("?",f),(f=this.m)&&a.push("#",Cr(f,$p)),a.join("")};function gt(a){return new ln(a)}function Gs(a,h,f){a.j=f?Pr(h,!0):h,a.j&&(a.j=a.j.replace(/:$/,""))}function Ws(a,h){if(h){if(h=Number(h),isNaN(h)||0>h)throw Error("Bad port number "+h);a.s=h}else a.s=null}function jc(a,h,f){h instanceof kr?(a.i=h,zp(a.i,a.h)):(f||(h=Cr(h,qp)),a.i=new kr(h,a.h))}function fe(a,h,f){a.i.set(h,f)}function Hs(a){return fe(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),a}function Pr(a,h){return a?h?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function Cr(a,h,f){return typeof a=="string"?(a=encodeURI(a).replace(h,Fp),f&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function Fp(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var Oc=/[#\/\?@]/g,Up=/[#\?:]/g,Bp=/[#\?]/g,qp=/[#\?@]/g,$p=/#/g;function kr(a,h){this.h=this.g=null,this.i=a||null,this.j=!!h}function Ct(a){a.g||(a.g=new Map,a.h=0,a.i&&Lp(a.i,function(h,f){a.add(decodeURIComponent(h.replace(/\+/g," ")),f)}))}r=kr.prototype,r.add=function(a,h){Ct(this),this.i=null,a=Un(this,a);var f=this.g.get(a);return f||this.g.set(a,f=[]),f.push(h),this.h+=1,this};function Mc(a,h){Ct(a),h=Un(a,h),a.g.has(h)&&(a.i=null,a.h-=a.g.get(h).length,a.g.delete(h))}function Lc(a,h){return Ct(a),h=Un(a,h),a.g.has(h)}r.forEach=function(a,h){Ct(this),this.g.forEach(function(f,g){f.forEach(function(S){a.call(h,S,g,this)},this)},this)},r.na=function(){Ct(this);const a=Array.from(this.g.values()),h=Array.from(this.g.keys()),f=[];for(let g=0;g<h.length;g++){const S=a[g];for(let k=0;k<S.length;k++)f.push(h[g])}return f},r.V=function(a){Ct(this);let h=[];if(typeof a=="string")Lc(this,a)&&(h=h.concat(this.g.get(Un(this,a))));else{a=Array.from(this.g.values());for(let f=0;f<a.length;f++)h=h.concat(a[f])}return h},r.set=function(a,h){return Ct(this),this.i=null,a=Un(this,a),Lc(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[h]),this.h+=1,this},r.get=function(a,h){return a?(a=this.V(a),0<a.length?String(a[0]):h):h};function Fc(a,h,f){Mc(a,h),0<f.length&&(a.i=null,a.g.set(Un(a,h),D(f)),a.h+=f.length)}r.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],h=Array.from(this.g.keys());for(var f=0;f<h.length;f++){var g=h[f];const k=encodeURIComponent(String(g)),U=this.V(g);for(g=0;g<U.length;g++){var S=k;U[g]!==""&&(S+="="+encodeURIComponent(String(U[g]))),a.push(S)}}return this.i=a.join("&")};function Un(a,h){return h=String(h),a.j&&(h=h.toLowerCase()),h}function zp(a,h){h&&!a.j&&(Ct(a),a.i=null,a.g.forEach(function(f,g){var S=g.toLowerCase();g!=S&&(Mc(this,g),Fc(this,S,f))},a)),a.j=h}function Kp(a,h){const f=new Rr;if(l.Image){const g=new Image;g.onload=E(kt,f,"TestLoadImage: loaded",!0,h,g),g.onerror=E(kt,f,"TestLoadImage: error",!1,h,g),g.onabort=E(kt,f,"TestLoadImage: abort",!1,h,g),g.ontimeout=E(kt,f,"TestLoadImage: timeout",!1,h,g),l.setTimeout(function(){g.ontimeout&&g.ontimeout()},1e4),g.src=a}else h(!1)}function Gp(a,h){const f=new Rr,g=new AbortController,S=setTimeout(()=>{g.abort(),kt(f,"TestPingServer: timeout",!1,h)},1e4);fetch(a,{signal:g.signal}).then(k=>{clearTimeout(S),k.ok?kt(f,"TestPingServer: ok",!0,h):kt(f,"TestPingServer: server error",!1,h)}).catch(()=>{clearTimeout(S),kt(f,"TestPingServer: error",!1,h)})}function kt(a,h,f,g,S){try{S&&(S.onload=null,S.onerror=null,S.onabort=null,S.ontimeout=null),g(f)}catch{}}function Wp(){this.g=new Np}function Hp(a,h,f){const g=f||"";try{Dc(a,function(S,k){let U=S;d(S)&&(U=Oo(S)),h.push(g+k+"="+encodeURIComponent(U))})}catch(S){throw h.push(g+"type="+encodeURIComponent("_badmap")),S}}function Qs(a){this.l=a.Ub||null,this.j=a.eb||!1}T(Qs,Mo),Qs.prototype.g=function(){return new Js(this.l,this.j)},Qs.prototype.i=function(a){return function(){return a}}({});function Js(a,h){Pe.call(this),this.D=a,this.o=h,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}T(Js,Pe),r=Js.prototype,r.open=function(a,h){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=a,this.A=h,this.readyState=1,Vr(this)},r.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const h={headers:this.u,method:this.B,credentials:this.m,cache:void 0};a&&(h.body=a),(this.D||l).fetch(new Request(this.A,h)).then(this.Sa.bind(this),this.ga.bind(this))},r.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Dr(this)),this.readyState=0},r.Sa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,Vr(this)),this.g&&(this.readyState=3,Vr(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof l.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Uc(this)}else a.text().then(this.Ra.bind(this),this.ga.bind(this))};function Uc(a){a.j.read().then(a.Pa.bind(a)).catch(a.ga.bind(a))}r.Pa=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var h=a.value?a.value:new Uint8Array(0);(h=this.v.decode(h,{stream:!a.done}))&&(this.response=this.responseText+=h)}a.done?Dr(this):Vr(this),this.readyState==3&&Uc(this)}},r.Ra=function(a){this.g&&(this.response=this.responseText=a,Dr(this))},r.Qa=function(a){this.g&&(this.response=a,Dr(this))},r.ga=function(){this.g&&Dr(this)};function Dr(a){a.readyState=4,a.l=null,a.j=null,a.v=null,Vr(a)}r.setRequestHeader=function(a,h){this.u.append(a,h)},r.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},r.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],h=this.h.entries();for(var f=h.next();!f.done;)f=f.value,a.push(f[0]+": "+f[1]),f=h.next();return a.join(`\r
`)};function Vr(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(Js.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function Bc(a){let h="";return R(a,function(f,g){h+=g,h+=":",h+=f,h+=`\r
`}),h}function Wo(a,h,f){e:{for(g in f){var g=!1;break e}g=!0}g||(f=Bc(f),typeof a=="string"?f!=null&&encodeURIComponent(String(f)):fe(a,h,f))}function _e(a){Pe.call(this),this.headers=new Map,this.o=a||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}T(_e,Pe);var Qp=/^https?$/i,Jp=["POST","PUT"];r=_e.prototype,r.Ha=function(a){this.J=a},r.ea=function(a,h,f,g){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);h=h?h.toUpperCase():"GET",this.D=a,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():Uo.g(),this.v=this.o?gc(this.o):gc(Uo),this.g.onreadystatechange=v(this.Ea,this);try{this.B=!0,this.g.open(h,String(a),!0),this.B=!1}catch(k){qc(this,k);return}if(a=f||"",f=new Map(this.headers),g)if(Object.getPrototypeOf(g)===Object.prototype)for(var S in g)f.set(S,g[S]);else if(typeof g.keys=="function"&&typeof g.get=="function")for(const k of g.keys())f.set(k,g.get(k));else throw Error("Unknown input type for opt_headers: "+String(g));g=Array.from(f.keys()).find(k=>k.toLowerCase()=="content-type"),S=l.FormData&&a instanceof l.FormData,!(0<=Array.prototype.indexOf.call(Jp,h,void 0))||g||S||f.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[k,U]of f)this.g.setRequestHeader(k,U);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{Kc(this),this.u=!0,this.g.send(a),this.u=!1}catch(k){qc(this,k)}};function qc(a,h){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=h,a.m=5,$c(a),Ys(a)}function $c(a){a.A||(a.A=!0,Le(a,"complete"),Le(a,"error"))}r.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=a||7,Le(this,"complete"),Le(this,"abort"),Ys(this))},r.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Ys(this,!0)),_e.aa.N.call(this)},r.Ea=function(){this.s||(this.B||this.u||this.j?zc(this):this.bb())},r.bb=function(){zc(this)};function zc(a){if(a.h&&typeof o<"u"&&(!a.v[1]||_t(a)!=4||a.Z()!=2)){if(a.u&&_t(a)==4)dc(a.Ea,0,a);else if(Le(a,"readystatechange"),_t(a)==4){a.h=!1;try{const U=a.Z();e:switch(U){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var h=!0;break e;default:h=!1}var f;if(!(f=h)){var g;if(g=U===0){var S=String(a.D).match(Vc)[1]||null;!S&&l.self&&l.self.location&&(S=l.self.location.protocol.slice(0,-1)),g=!Qp.test(S?S.toLowerCase():"")}f=g}if(f)Le(a,"complete"),Le(a,"success");else{a.m=6;try{var k=2<_t(a)?a.g.statusText:""}catch{k=""}a.l=k+" ["+a.Z()+"]",$c(a)}}finally{Ys(a)}}}}function Ys(a,h){if(a.g){Kc(a);const f=a.g,g=a.v[0]?()=>{}:null;a.g=null,a.v=null,h||Le(a,"ready");try{f.onreadystatechange=g}catch{}}}function Kc(a){a.I&&(l.clearTimeout(a.I),a.I=null)}r.isActive=function(){return!!this.g};function _t(a){return a.g?a.g.readyState:0}r.Z=function(){try{return 2<_t(this)?this.g.status:-1}catch{return-1}},r.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},r.Oa=function(a){if(this.g){var h=this.g.responseText;return a&&h.indexOf(a)==0&&(h=h.substring(a.length)),Rp(h)}};function Gc(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.H){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function Yp(a){const h={};a=(a.g&&2<=_t(a)&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let g=0;g<a.length;g++){if(O(a[g]))continue;var f=b(a[g]);const S=f[0];if(f=f[1],typeof f!="string")continue;f=f.trim();const k=h[S]||[];h[S]=k,k.push(f)}x(h,function(g){return g.join(", ")})}r.Ba=function(){return this.m},r.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function jr(a,h,f){return f&&f.internalChannelParams&&f.internalChannelParams[a]||h}function Wc(a){this.Aa=0,this.i=[],this.j=new Rr,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=jr("failFast",!1,a),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=jr("baseRetryDelayMs",5e3,a),this.cb=jr("retryDelaySeedMs",1e4,a),this.Wa=jr("forwardChannelMaxRetries",2,a),this.wa=jr("forwardChannelRequestTimeoutMs",2e4,a),this.pa=a&&a.xmlHttpFactory||void 0,this.Xa=a&&a.Tb||void 0,this.Ca=a&&a.useFetchStreams||!1,this.L=void 0,this.J=a&&a.supportsCrossDomainXhr||!1,this.K="",this.h=new Rc(a&&a.concurrentRequestLimit),this.Da=new Wp,this.P=a&&a.fastHandshake||!1,this.O=a&&a.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=a&&a.Rb||!1,a&&a.xa&&this.j.xa(),a&&a.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&a&&a.detectBufferingProxy||!1,this.ja=void 0,a&&a.longPollingTimeout&&0<a.longPollingTimeout&&(this.ja=a.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}r=Wc.prototype,r.la=8,r.G=1,r.connect=function(a,h,f,g){Fe(0),this.W=a,this.H=h||{},f&&g!==void 0&&(this.H.OSID=f,this.H.OAID=g),this.F=this.X,this.I=nu(this,null,this.W),Zs(this)};function Ho(a){if(Hc(a),a.G==3){var h=a.U++,f=gt(a.I);if(fe(f,"SID",a.K),fe(f,"RID",h),fe(f,"TYPE","terminate"),Or(a,f),h=new Pt(a,a.j,h),h.L=2,h.v=Hs(gt(f)),f=!1,l.navigator&&l.navigator.sendBeacon)try{f=l.navigator.sendBeacon(h.v.toString(),"")}catch{}!f&&l.Image&&(new Image().src=h.v,f=!0),f||(h.g=ru(h.j,null),h.g.ea(h.v)),h.F=Date.now(),Ks(h)}tu(a)}function Xs(a){a.g&&(Jo(a),a.g.cancel(),a.g=null)}function Hc(a){Xs(a),a.u&&(l.clearTimeout(a.u),a.u=null),ei(a),a.h.cancel(),a.s&&(typeof a.s=="number"&&l.clearTimeout(a.s),a.s=null)}function Zs(a){if(!Nc(a.h)&&!a.s){a.s=!0;var h=a.Ga;H||Je(),X||(H(),X=!0),oe.add(h,a),a.B=0}}function Xp(a,h){return Pc(a.h)>=a.h.j-(a.s?1:0)?!1:a.s?(a.i=h.D.concat(a.i),!0):a.G==1||a.G==2||a.B>=(a.Va?0:a.Wa)?!1:(a.s=Sr(v(a.Ga,a,h),eu(a,a.B)),a.B++,!0)}r.Ga=function(a){if(this.s)if(this.s=null,this.G==1){if(!a){this.U=Math.floor(1e5*Math.random()),a=this.U++;const S=new Pt(this,this.j,a);let k=this.o;if(this.S&&(k?(k=_(k),I(k,this.S)):k=this.S),this.m!==null||this.O||(S.H=k,k=null),this.P)e:{for(var h=0,f=0;f<this.i.length;f++){t:{var g=this.i[f];if("__data__"in g.map&&(g=g.map.__data__,typeof g=="string")){g=g.length;break t}g=void 0}if(g===void 0)break;if(h+=g,4096<h){h=f;break e}if(h===4096||f===this.i.length-1){h=f+1;break e}}h=1e3}else h=1e3;h=Jc(this,S,h),f=gt(this.I),fe(f,"RID",a),fe(f,"CVER",22),this.D&&fe(f,"X-HTTP-Session-Id",this.D),Or(this,f),k&&(this.O?h="headers="+encodeURIComponent(String(Bc(k)))+"&"+h:this.m&&Wo(f,this.m,k)),Go(this.h,S),this.Ua&&fe(f,"TYPE","init"),this.P?(fe(f,"$req",h),fe(f,"SID","null"),S.T=!0,qo(S,f,null)):qo(S,f,h),this.G=2}}else this.G==3&&(a?Qc(this,a):this.i.length==0||Nc(this.h)||Qc(this))};function Qc(a,h){var f;h?f=h.l:f=a.U++;const g=gt(a.I);fe(g,"SID",a.K),fe(g,"RID",f),fe(g,"AID",a.T),Or(a,g),a.m&&a.o&&Wo(g,a.m,a.o),f=new Pt(a,a.j,f,a.B+1),a.m===null&&(f.H=a.o),h&&(a.i=h.D.concat(a.i)),h=Jc(a,f,1e3),f.I=Math.round(.5*a.wa)+Math.round(.5*a.wa*Math.random()),Go(a.h,f),qo(f,g,h)}function Or(a,h){a.H&&R(a.H,function(f,g){fe(h,g,f)}),a.l&&Dc({},function(f,g){fe(h,g,f)})}function Jc(a,h,f){f=Math.min(a.i.length,f);var g=a.l?v(a.l.Na,a.l,a):null;e:{var S=a.i;let k=-1;for(;;){const U=["count="+f];k==-1?0<f?(k=S[0].g,U.push("ofs="+k)):k=0:U.push("ofs="+k);let he=!0;for(let Re=0;Re<f;Re++){let ie=S[Re].g;const Ce=S[Re].map;if(ie-=k,0>ie)k=Math.max(0,S[Re].g-100),he=!1;else try{Hp(Ce,U,"req"+ie+"_")}catch{g&&g(Ce)}}if(he){g=U.join("&");break e}}}return a=a.i.splice(0,f),h.D=a,g}function Yc(a){if(!a.g&&!a.u){a.Y=1;var h=a.Fa;H||Je(),X||(H(),X=!0),oe.add(h,a),a.v=0}}function Qo(a){return a.g||a.u||3<=a.v?!1:(a.Y++,a.u=Sr(v(a.Fa,a),eu(a,a.v)),a.v++,!0)}r.Fa=function(){if(this.u=null,Xc(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var a=2*this.R;this.j.info("BP detection timer enabled: "+a),this.A=Sr(v(this.ab,this),a)}},r.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,Fe(10),Xs(this),Xc(this))};function Jo(a){a.A!=null&&(l.clearTimeout(a.A),a.A=null)}function Xc(a){a.g=new Pt(a,a.j,"rpc",a.Y),a.m===null&&(a.g.H=a.o),a.g.O=0;var h=gt(a.qa);fe(h,"RID","rpc"),fe(h,"SID",a.K),fe(h,"AID",a.T),fe(h,"CI",a.F?"0":"1"),!a.F&&a.ja&&fe(h,"TO",a.ja),fe(h,"TYPE","xmlhttp"),Or(a,h),a.m&&a.o&&Wo(h,a.m,a.o),a.L&&(a.g.I=a.L);var f=a.g;a=a.ia,f.L=1,f.v=Hs(gt(h)),f.m=null,f.P=!0,Tc(f,a)}r.Za=function(){this.C!=null&&(this.C=null,Xs(this),Qo(this),Fe(19))};function ei(a){a.C!=null&&(l.clearTimeout(a.C),a.C=null)}function Zc(a,h){var f=null;if(a.g==h){ei(a),Jo(a),a.g=null;var g=2}else if(Ko(a.h,h))f=h.D,Cc(a.h,h),g=1;else return;if(a.G!=0){if(h.o)if(g==1){f=h.m?h.m.length:0,h=Date.now()-h.F;var S=a.B;g=qs(),Le(g,new xc(g,f)),Zs(a)}else Yc(a);else if(S=h.s,S==3||S==0&&0<h.X||!(g==1&&Xp(a,h)||g==2&&Qo(a)))switch(f&&0<f.length&&(h=a.h,h.i=h.i.concat(f)),S){case 1:cn(a,5);break;case 4:cn(a,10);break;case 3:cn(a,6);break;default:cn(a,2)}}}function eu(a,h){let f=a.Ta+Math.floor(Math.random()*a.cb);return a.isActive()||(f*=2),f*h}function cn(a,h){if(a.j.info("Error code "+h),h==2){var f=v(a.fb,a),g=a.Xa;const S=!g;g=new ln(g||"//www.google.com/images/cleardot.gif"),l.location&&l.location.protocol=="http"||Gs(g,"https"),Hs(g),S?Kp(g.toString(),f):Gp(g.toString(),f)}else Fe(2);a.G=0,a.l&&a.l.sa(h),tu(a),Hc(a)}r.fb=function(a){a?(this.j.info("Successfully pinged google.com"),Fe(2)):(this.j.info("Failed to ping google.com"),Fe(1))};function tu(a){if(a.G=0,a.ka=[],a.l){const h=kc(a.h);(h.length!=0||a.i.length!=0)&&(C(a.ka,h),C(a.ka,a.i),a.h.i.length=0,D(a.i),a.i.length=0),a.l.ra()}}function nu(a,h,f){var g=f instanceof ln?gt(f):new ln(f);if(g.g!="")h&&(g.g=h+"."+g.g),Ws(g,g.s);else{var S=l.location;g=S.protocol,h=h?h+"."+S.hostname:S.hostname,S=+S.port;var k=new ln(null);g&&Gs(k,g),h&&(k.g=h),S&&Ws(k,S),f&&(k.l=f),g=k}return f=a.D,h=a.ya,f&&h&&fe(g,f,h),fe(g,"VER",a.la),Or(a,g),g}function ru(a,h,f){if(h&&!a.J)throw Error("Can't create secondary domain capable XhrIo object.");return h=a.Ca&&!a.pa?new _e(new Qs({eb:f})):new _e(a.pa),h.Ha(a.J),h}r.isActive=function(){return!!this.l&&this.l.isActive(this)};function su(){}r=su.prototype,r.ua=function(){},r.ta=function(){},r.sa=function(){},r.ra=function(){},r.isActive=function(){return!0},r.Na=function(){};function ti(){}ti.prototype.g=function(a,h){return new Ke(a,h)};function Ke(a,h){Pe.call(this),this.g=new Wc(h),this.l=a,this.h=h&&h.messageUrlParams||null,a=h&&h.messageHeaders||null,h&&h.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=h&&h.initMessageHeaders||null,h&&h.messageContentType&&(a?a["X-WebChannel-Content-Type"]=h.messageContentType:a={"X-WebChannel-Content-Type":h.messageContentType}),h&&h.va&&(a?a["X-WebChannel-Client-Profile"]=h.va:a={"X-WebChannel-Client-Profile":h.va}),this.g.S=a,(a=h&&h.Sb)&&!O(a)&&(this.g.m=a),this.v=h&&h.supportsCrossDomainXhr||!1,this.u=h&&h.sendRawJson||!1,(h=h&&h.httpSessionIdParam)&&!O(h)&&(this.g.D=h,a=this.h,a!==null&&h in a&&(a=this.h,h in a&&delete a[h])),this.j=new Bn(this)}T(Ke,Pe),Ke.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Ke.prototype.close=function(){Ho(this.g)},Ke.prototype.o=function(a){var h=this.g;if(typeof a=="string"){var f={};f.__data__=a,a=f}else this.u&&(f={},f.__data__=Oo(a),a=f);h.i.push(new jp(h.Ya++,a)),h.G==3&&Zs(h)},Ke.prototype.N=function(){this.g.l=null,delete this.j,Ho(this.g),delete this.g,Ke.aa.N.call(this)};function iu(a){Lo.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var h=a.__sm__;if(h){e:{for(const f in h){a=f;break e}a=void 0}(this.i=a)&&(a=this.i,h=h!==null&&a in h?h[a]:void 0),this.data=h}else this.data=a}T(iu,Lo);function ou(){Fo.call(this),this.status=1}T(ou,Fo);function Bn(a){this.g=a}T(Bn,su),Bn.prototype.ua=function(){Le(this.g,"a")},Bn.prototype.ta=function(a){Le(this.g,new iu(a))},Bn.prototype.sa=function(a){Le(this.g,new ou)},Bn.prototype.ra=function(){Le(this.g,"b")},ti.prototype.createWebChannel=ti.prototype.g,Ke.prototype.send=Ke.prototype.o,Ke.prototype.open=Ke.prototype.m,Ke.prototype.close=Ke.prototype.close,uf=function(){return new ti},cf=function(){return qs()},lf=on,Pa={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},$s.NO_ERROR=0,$s.TIMEOUT=8,$s.HTTP_ERROR=6,vi=$s,wc.COMPLETE="complete",af=wc,_c.EventType=Tr,Tr.OPEN="a",Tr.CLOSE="b",Tr.ERROR="c",Tr.MESSAGE="d",Pe.prototype.listen=Pe.prototype.K,Kr=_c,_e.prototype.listenOnce=_e.prototype.L,_e.prototype.getLastError=_e.prototype.Ka,_e.prototype.getLastErrorCode=_e.prototype.Ba,_e.prototype.getStatus=_e.prototype.Z,_e.prototype.getResponseJson=_e.prototype.Oa,_e.prototype.getResponseText=_e.prototype.oa,_e.prototype.send=_e.prototype.ea,_e.prototype.setWithCredentials=_e.prototype.Ha,of=_e}).apply(typeof si<"u"?si:typeof self<"u"?self:typeof window<"u"?window:{});const Uu="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class je{constructor(e){this.value=e}static empty(){return new je({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let n=0;n<e.length-1;++n)if(t=(t.mapValue.fields||{})[e.get(n)],!Ii(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Zr(t)}setAll(e){let t=pe.emptyPath(),n={},s=[];e.forEach((o,l)=>{if(!t.isImmediateParentOf(l)){const c=this.getFieldsMap(t);this.applyChanges(c,n,s),n={},s=[],t=l.popLast()}o?n[l.lastSegment()]=Zr(o):s.push(l.lastSegment())});const i=this.getFieldsMap(t);this.applyChanges(i,n,s)}delete(e){const t=this.field(e.popLast());Ii(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return dt(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let n=0;n<e.length;++n){let s=t.mapValue.fields[e.get(n)];Ii(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(n)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,n){kn(t,(s,i)=>e[s]=i);for(const s of n)delete e[s]}clone(){return new je(Zr(this.value))}}function Sf(r){const e=[];return kn(r.fields,(t,n)=>{const s=new pe([t]);if(Ii(n)){const i=Sf(n.mapValue).fields;if(i.length===0)e.push(s);else for(const o of i)e.push(s.child(o))}else e.push(s)}),new ze(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fi{constructor(e,t="asc"){this.field=e,this.dir=t}}function Yb(r,e){return r.dir===e.dir&&r.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sx{constructor(e,t=null,n=[],s=[],i=null,o=null,l=null){this.path=e,this.collectionGroup=t,this.orderBy=n,this.filters=s,this.limit=i,this.startAt=o,this.endAt=l,this.ue=null}}function Ma(r,e=null,t=[],n=[],s=null,i=null,o=null){return new sx(r,e,t,n,s,i,o)}function An(r){const e=G(r);if(e.ue===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map(n=>Oa(n)).join(","),t+="|ob:",t+=e.orderBy.map(n=>function(i){return i.field.canonicalString()+i.dir}(n)).join(","),uo(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map(n=>ir(n)).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map(n=>ir(n)).join(",")),e.ue=t}return e.ue}function Ss(r,e){if(r.limit!==e.limit||r.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<r.orderBy.length;t++)if(!Yb(r.orderBy[t],e.orderBy[t]))return!1;if(r.filters.length!==e.filters.length)return!1;for(let t=0;t<r.filters.length;t++)if(!Pf(r.filters[t],e.filters[t]))return!1;return r.collectionGroup===e.collectionGroup&&!!r.path.isEqual(e.path)&&!!Zu(r.startAt,e.startAt)&&Zu(r.endAt,e.endAt)}function Ui(r){return q.isDocumentKey(r.path)&&r.collectionGroup===null&&r.filters.length===0}function Bi(r,e){return r.filters.filter(t=>t instanceof ne&&t.field.isEqual(e))}function eh(r,e,t){let n=wi,s=!0;for(const i of Bi(r,e)){let o=wi,l=!0;switch(i.op){case"<":case"<=":o=Qb(i.value);break;case"==":case"in":case">=":o=i.value;break;case">":o=i.value,l=!1;break;case"!=":case"not-in":o=wi}Ju({value:n,inclusive:s},{value:o,inclusive:l})<0&&(n=o,s=l)}if(t!==null){for(let i=0;i<r.orderBy.length;++i)if(r.orderBy[i].field.isEqual(e)){const o=t.position[i];Ju({value:n,inclusive:s},{value:o,inclusive:t.inclusive})<0&&(n=o,s=t.inclusive);break}}return{value:n,inclusive:s}}function th(r,e,t){let n=Bt,s=!0;for(const i of Bi(r,e)){let o=Bt,l=!0;switch(i.op){case">=":case">":o=Jb(i.value),l=!1;break;case"==":case"in":case"<=":o=i.value;break;case"<":o=i.value,l=!1;break;case"!=":case"not-in":o=Bt}Yu({value:n,inclusive:s},{value:o,inclusive:l})>0&&(n=o,s=l)}if(t!==null){for(let i=0;i<r.orderBy.length;++i)if(r.orderBy[i].field.isEqual(e)){const o=t.position[i];Yu({value:n,inclusive:s},{value:o,inclusive:t.inclusive})>0&&(n=o,s=t.inclusive);break}}return{value:n,inclusive:s}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mo{constructor(){this._=void 0}}function dx(r,e,t){return r instanceof lr?function(s,i){const o={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&yl(i)&&(i=vl(i)),i&&(o.fields.__previous_value__=i),{mapValue:o}}(t,e):r instanceof cr?Kf(r,e):r instanceof ur?Gf(r,e):function(s,i){const o=zf(s,i),l=rh(o)+rh(s.Pe);return Va(o)&&Va(s.Pe)?$f(l):wl(s.serializer,l)}(r,e)}function fx(r,e,t){return r instanceof cr?Kf(r,e):r instanceof ur?Gf(r,e):t}function zf(r,e){return r instanceof _s?function(n){return Va(n)||function(i){return!!i&&"doubleValue"in i}(n)}(e)?e:{integerValue:0}:null}class lr extends mo{}class cr extends mo{constructor(e){super(),this.elements=e}}function Kf(r,e){const t=Wf(e);for(const n of r.elements)t.some(s=>dt(s,n))||t.push(n);return{arrayValue:{values:t}}}class ur extends mo{constructor(e){super(),this.elements=e}}function Gf(r,e){let t=Wf(e);for(const n of r.elements)t=t.filter(s=>!dt(s,n));return{arrayValue:{values:t}}}class _s extends mo{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function rh(r){return me(r.integerValue||r.doubleValue)}function Wf(r){return gs(r)&&r.arrayValue.values?r.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hf{constructor(e,t){this.field=e,this.transform=t}}function mx(r,e){return r.field.isEqual(e.field)&&function(n,s){return n instanceof cr&&s instanceof cr||n instanceof ur&&s instanceof ur?sr(n.elements,s.elements,dt):n instanceof _s&&s instanceof _s?dt(n.Pe,s.Pe):n instanceof lr&&s instanceof lr}(r.transform,e.transform)}class px{constructor(e,t){this.version=e,this.transformResults=t}}class Oe{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new Oe}static exists(e){return new Oe(void 0,e)}static updateTime(e){return new Oe(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function Ei(r,e){return r.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(r.updateTime):r.exists===void 0||r.exists===e.isFoundDocument()}class po{}function Qf(r,e){if(!r.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return r.isNoDocument()?new go(r.key,Oe.none()):new br(r.key,r.data,Oe.none());{const t=r.data,n=je.empty();let s=new ce(pe.comparator);for(let i of e.fields)if(!s.has(i)){let o=t.field(i);o===null&&i.length>1&&(i=i.popLast(),o=t.field(i)),o===null?n.delete(i):n.set(i,o),s=s.add(i)}return new Rt(r.key,n,new ze(s.toArray()),Oe.none())}}function gx(r,e,t){r instanceof br?function(s,i,o){const l=s.value.clone(),c=ih(s.fieldTransforms,i,o.transformResults);l.setAll(c),i.convertToFoundDocument(o.version,l).setHasCommittedMutations()}(r,e,t):r instanceof Rt?function(s,i,o){if(!Ei(s.precondition,i))return void i.convertToUnknownDocument(o.version);const l=ih(s.fieldTransforms,i,o.transformResults),c=i.data;c.setAll(Jf(s)),c.setAll(l),i.convertToFoundDocument(o.version,c).setHasCommittedMutations()}(r,e,t):function(s,i,o){i.convertToNoDocument(o.version).setHasCommittedMutations()}(0,e,t)}function ns(r,e,t,n){return r instanceof br?function(i,o,l,c){if(!Ei(i.precondition,o))return l;const d=i.value.clone(),m=oh(i.fieldTransforms,c,o);return d.setAll(m),o.convertToFoundDocument(o.version,d).setHasLocalMutations(),null}(r,e,t,n):r instanceof Rt?function(i,o,l,c){if(!Ei(i.precondition,o))return l;const d=oh(i.fieldTransforms,c,o),m=o.data;return m.setAll(Jf(i)),m.setAll(d),o.convertToFoundDocument(o.version,m).setHasLocalMutations(),l===null?null:l.unionWith(i.fieldMask.fields).unionWith(i.fieldTransforms.map(p=>p.field))}(r,e,t,n):function(i,o,l){return Ei(i.precondition,o)?(o.convertToNoDocument(o.version).setHasLocalMutations(),null):l}(r,e,t)}function _x(r,e){let t=null;for(const n of r.fieldTransforms){const s=e.data.field(n.field),i=zf(n.transform,s||null);i!=null&&(t===null&&(t=je.empty()),t.set(n.field,i))}return t||null}function sh(r,e){return r.type===e.type&&!!r.key.isEqual(e.key)&&!!r.precondition.isEqual(e.precondition)&&!!function(n,s){return n===void 0&&s===void 0||!(!n||!s)&&sr(n,s,(i,o)=>mx(i,o))}(r.fieldTransforms,e.fieldTransforms)&&(r.type===0?r.value.isEqual(e.value):r.type!==1||r.data.isEqual(e.data)&&r.fieldMask.isEqual(e.fieldMask))}class br extends po{constructor(e,t,n,s=[]){super(),this.key=e,this.value=t,this.precondition=n,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class Rt extends po{constructor(e,t,n,s,i=[]){super(),this.key=e,this.data=t,this.fieldMask=n,this.precondition=s,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function Jf(r){const e=new Map;return r.fieldMask.fields.forEach(t=>{if(!t.isEmpty()){const n=r.data.field(t);e.set(t,n)}}),e}function ih(r,e,t){const n=new Map;W(r.length===t.length);for(let s=0;s<t.length;s++){const i=r[s],o=i.transform,l=e.data.field(i.field);n.set(i.field,fx(o,l,t[s]))}return n}function oh(r,e,t){const n=new Map;for(const s of r){const i=s.transform,o=t.data.field(s.field);n.set(s.field,dx(i,o,e))}return n}class go extends po{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class Yf extends po{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _o{constructor(e,t){this.serializer=e,this.userId=t}static lt(e,t){const n=t.uid||"";return new _o(e,n)}getOverlay(e,t){return Mr(e).get(mh(this.userId,t)).next(n=>n?oa(this.serializer,n):null)}getOverlays(e,t){const n=it();return N.forEach(t,s=>this.getOverlay(e,s).next(i=>{i!==null&&n.set(s,i)})).next(()=>n)}saveOverlays(e,t,n){const s=[];return n.forEach((i,o)=>{const l=new Tl(t,o);s.push(this.ht(e,l))}),N.waitFor(s)}removeOverlaysForBatchId(e,t,n){const s=new Set;t.forEach(o=>s.add(Ue(o.getCollectionPath())));const i=[];return s.forEach(o=>{const l=IDBKeyRange.bound([this.userId,o,n],[this.userId,o,n+1],!1,!0);i.push(Mr(e).j("collectionPathOverlayIndex",l))}),N.waitFor(i)}getOverlaysForCollection(e,t,n){const s=it(),i=Ue(t),o=IDBKeyRange.bound([this.userId,i,n],[this.userId,i,Number.POSITIVE_INFINITY],!0);return Mr(e).U("collectionPathOverlayIndex",o).next(l=>{for(const c of l){const d=oa(this.serializer,c);s.set(d.getKey(),d)}return s})}getOverlaysForCollectionGroup(e,t,n,s){const i=it();let o;const l=IDBKeyRange.bound([this.userId,t,n],[this.userId,t,Number.POSITIVE_INFINITY],!0);return Mr(e).J({index:"collectionGroupOverlayIndex",range:l},(c,d,m)=>{const p=oa(this.serializer,d);i.size()<s||p.largestBatchId===o?(i.set(p.getKey(),p),o=p.largestBatchId):m.done()}).next(()=>i)}ht(e,t){return Mr(e).put(function(s,i,o){const[l,c,d]=mh(i,o.mutation.key);return{userId:i,collectionPath:c,documentId:d,collectionGroup:o.mutation.key.getCollectionGroup(),largestBatchId:o.largestBatchId,overlayMutation:$i(s.ct,o.mutation)}}(this.serializer,this.userId,t))}}function Mr(r){return Ae(r,"documentOverlays")}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Im{constructor(e,t){this.qr={},this.overlays={},this.Qr=new $e(0),this.Kr=!1,this.Kr=!0,this.$r=new rw,this.referenceDelegate=e(this),this.Ur=new aw(this),this.indexManager=new zx,this.remoteDocumentCache=function(s){return new iw(s)}(n=>this.referenceDelegate.Wr(n)),this.serializer=new dm(t),this.Gr=new tw(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Kr=!1,Promise.resolve()}get started(){return this.Kr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new nw,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let n=this.qr[e.toKey()];return n||(n=new sw(t,this.referenceDelegate),this.qr[e.toKey()]=n),n}getGlobalsCache(){return this.$r}getTargetCache(){return this.Ur}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Gr}runTransaction(e,t,n){j("MemoryPersistence","Starting transaction:",e);const s=new lw(this.Qr.next());return this.referenceDelegate.zr(),n(s).next(i=>this.referenceDelegate.jr(s).next(()=>i)).toPromise().then(i=>(s.raiseOnCommittedEvent(),i))}Hr(e,t){return N.or(Object.values(this.qr).map(n=>()=>n.containsKey(e,t)))}}class lw extends gf{constructor(e){super(),this.currentSequenceNumber=e}}class vo{constructor(e){this.persistence=e,this.Jr=new Pl,this.Yr=null}static Zr(e){return new vo(e)}get Xr(){if(this.Yr)return this.Yr;throw K()}addReference(e,t,n){return this.Jr.addReference(n,t),this.Xr.delete(n.toString()),N.resolve()}removeReference(e,t,n){return this.Jr.removeReference(n,t),this.Xr.add(n.toString()),N.resolve()}markPotentiallyOrphaned(e,t){return this.Xr.add(t.toString()),N.resolve()}removeTarget(e,t){this.Jr.gr(t.targetId).forEach(s=>this.Xr.add(s.toString()));const n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(e,t.targetId).next(s=>{s.forEach(i=>this.Xr.add(i.toString()))}).next(()=>n.removeTargetData(e,t))}zr(){this.Yr=new Set}jr(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return N.forEach(this.Xr,n=>{const s=q.fromPath(n);return this.ei(e,s).next(i=>{i||t.removeEntry(s,Q.min())})}).next(()=>(this.Yr=null,t.apply(e)))}updateLimboDocument(e,t){return this.ei(e,t).next(n=>{n?this.Xr.delete(t.toString()):this.Xr.add(t.toString())})}Wr(e){return 0}ei(e,t){return N.or([()=>N.resolve(this.Jr.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Hr(e,t)])}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ci=null;function ua(){return ci===null?ci=function(){return 268435456+Math.round(2147483648*Math.random())}():ci++,"0x"+ci.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const De="WebChannelConnection";class vw extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const n=t.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.Do=n+"://"+t.host,this.vo=`projects/${s}/databases/${i}`,this.Co=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${i}`}get Fo(){return!1}Mo(t,n,s,i,o){const l=ua(),c=this.xo(t,n.toUriEncodedString());j("RestConnection",`Sending RPC '${t}' ${l}:`,c,s);const d={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(d,i,o),this.No(t,c,d,s).then(m=>(j("RestConnection",`Received RPC '${t}' ${l}: `,m),m),m=>{throw cs("RestConnection",`RPC '${t}' ${l} failed with error: `,m,"url: ",c,"request:",s),m})}Lo(t,n,s,i,o,l){return this.Mo(t,n,s,i,o)}Oo(t,n,s){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+vr}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),n&&n.headers.forEach((i,o)=>t[o]=i),s&&s.headers.forEach((i,o)=>t[o]=i)}xo(t,n){const s=_w[t];return`${this.Do}/v1/${n}:${s}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,n,s){const i=ua();return new Promise((o,l)=>{const c=new of;c.setWithCredentials(!0),c.listenOnce(af.COMPLETE,()=>{try{switch(c.getLastErrorCode()){case vi.NO_ERROR:const m=c.getResponseJson();j(De,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(m)),o(m);break;case vi.TIMEOUT:j(De,`RPC '${e}' ${i} timed out`),l(new B(V.DEADLINE_EXCEEDED,"Request time out"));break;case vi.HTTP_ERROR:const p=c.getStatus();if(j(De,`RPC '${e}' ${i} failed with status:`,p,"response text:",c.getResponseText()),p>0){let v=c.getResponseJson();Array.isArray(v)&&(v=v[0]);const E=v?.error;if(E&&E.status&&E.message){const T=function(C){const F=C.toLowerCase().replace(/_/g,"-");return Object.values(V).indexOf(F)>=0?F:V.UNKNOWN}(E.status);l(new B(T,E.message))}else l(new B(V.UNKNOWN,"Server responded with status "+c.getStatus()))}else l(new B(V.UNAVAILABLE,"Connection failed."));break;default:K()}}finally{j(De,`RPC '${e}' ${i} completed.`)}});const d=JSON.stringify(s);j(De,`RPC '${e}' ${i} sending request:`,s),c.send(t,"POST",d,n,15)})}Bo(e,t,n){const s=ua(),i=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=uf(),l=cf(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(c.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(c.useFetchStreams=!0),this.Oo(c.initMessageHeaders,t,n),c.encodeInitMessageHeaders=!0;const m=i.join("");j(De,`Creating RPC '${e}' stream ${s}: ${m}`,c);const p=o.createWebChannel(m,c);let v=!1,E=!1;const T=new yw({Io:C=>{E?j(De,`Not sending because RPC '${e}' stream ${s} is closed:`,C):(v||(j(De,`Opening RPC '${e}' stream ${s} transport.`),p.open(),v=!0),j(De,`RPC '${e}' stream ${s} sending:`,C),p.send(C))},To:()=>p.close()}),D=(C,F,O)=>{C.listen(F,L=>{try{O(L)}catch($){setTimeout(()=>{throw $},0)}})};return D(p,Kr.EventType.OPEN,()=>{E||(j(De,`RPC '${e}' stream ${s} transport opened.`),T.yo())}),D(p,Kr.EventType.CLOSE,()=>{E||(E=!0,j(De,`RPC '${e}' stream ${s} transport closed`),T.So())}),D(p,Kr.EventType.ERROR,C=>{E||(E=!0,cs(De,`RPC '${e}' stream ${s} transport errored:`,C),T.So(new B(V.UNAVAILABLE,"The operation could not be completed")))}),D(p,Kr.EventType.MESSAGE,C=>{var F;if(!E){const O=C.data[0];W(!!O);const L=O,$=L.error||((F=L[0])===null||F===void 0?void 0:F.error);if($){j(De,`RPC '${e}' stream ${s} received error:`,$);const P=$.status;let R=function(w){const I=we[w];if(I!==void 0)return Xf(I)}(P),x=$.message;R===void 0&&(R=V.INTERNAL,x="Unknown error status: "+P+" with message "+$.message),E=!0,T.So(new B(R,x)),p.close()}else j(De,`RPC '${e}' stream ${s} received:`,O),T.bo(O)}}),D(l,lf.STAT_EVENT,C=>{C.stat===Pa.PROXY?j(De,`RPC '${e}' stream ${s} detected buffering proxy`):C.stat===Pa.NOPROXY&&j(De,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{T.wo()},0),T}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dm(){return typeof window<"u"?window:null}function Ai(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bo(r){return new Ax(r,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ao{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new B(V.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new pe(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qr{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class ap extends rp{constructor(e,t,n,s,i,o){super(e,t,n,s,o),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new Si(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const n=this._document.data.field(nc("DocumentSnapshot.get",e));if(n!==null)return this._userDataWriter.convertValue(n,t.serverTimestamps)}}}class Si extends ap{data(e={}){return super.data(e)}}class lp{constructor(e,t,n,s){this._firestore=e,this._userDataWriter=t,this._snapshot=s,this.metadata=new Qr(s.hasPendingWrites,s.fromCache),this.query=n}get docs(){const e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,t){this._snapshot.docs.forEach(n=>{e.call(t,new Si(this._firestore,this._userDataWriter,n.key,n,new Qr(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new B(V.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(s,i){if(s._snapshot.oldDocs.isEmpty()){let o=0;return s._snapshot.docChanges.map(l=>{const c=new Si(s._firestore,s._userDataWriter,l.doc.key,l.doc,new Qr(s._snapshot.mutatedKeys.has(l.doc.key),s._snapshot.fromCache),s.query.converter);return l.doc,{type:"added",doc:c,oldIndex:-1,newIndex:o++}})}{let o=s._snapshot.oldDocs;return s._snapshot.docChanges.filter(l=>i||l.type!==3).map(l=>{const c=new Si(s._firestore,s._userDataWriter,l.doc.key,l.doc,new Qr(s._snapshot.mutatedKeys.has(l.doc.key),s._snapshot.fromCache),s.query.converter);let d=-1,m=-1;return l.type!==0&&(d=o.indexOf(l.doc.key),o=o.delete(l.doc.key)),l.type!==1&&(o=o.add(l.doc),m=o.indexOf(l.doc.key)),{type:S0(l.type),doc:c,oldIndex:d,newIndex:m}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}function S0(r){switch(r){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return K()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nt{constructor(e,t){this.bucket=e,this.path_=t}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let n;try{n=nt.makeFromUrl(e,t)}catch{return new nt(e,"")}if(n.path==="")return n;throw z0(e)}static makeFromUrl(e,t){let n=null;const s="([A-Za-z0-9.\\-_]+)";function i($){$.path.charAt($.path.length-1)==="/"&&($.path_=$.path_.slice(0,-1))}const o="(/(.*))?$",l=new RegExp("^gs://"+s+o,"i"),c={bucket:1,path:3};function d($){$.path_=decodeURIComponent($.path)}const m="v[A-Za-z0-9_]+",p=t.replace(/[.]/g,"\\."),v="(/([^?#]*).*)?$",E=new RegExp(`^https?://${p}/${m}/b/${s}/o${v}`,"i"),T={bucket:1,path:3},D=t===hp?"(?:storage.googleapis.com|storage.cloud.google.com)":t,C="([^?#]*)",F=new RegExp(`^https?://${D}/${s}/${C}`,"i"),L=[{regex:l,indices:c,postModify:i},{regex:E,indices:T,postModify:d},{regex:F,indices:{bucket:1,path:2},postModify:d}];for(let $=0;$<L.length;$++){const P=L[$],R=P.regex.exec(e);if(R){const x=R[P.indices.bucket];let _=R[P.indices.path];_||(_=""),n=new nt(x,_),P.postModify(n);break}}if(n==null)throw $0(e);return n}}class G0{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function W0(r,e,t){let n=1,s=null,i=null,o=!1,l=0;function c(){return l===2}let d=!1;function m(...C){d||(d=!0,e.apply(null,C))}function p(C){s=setTimeout(()=>{s=null,r(E,c())},C)}function v(){i&&clearTimeout(i)}function E(C,...F){if(d){v();return}if(C){v(),m.call(null,C,...F);return}if(c()||o){v(),m.call(null,C,...F);return}n<64&&(n*=2);let L;l===1?(l=2,L=0):L=(n+Math.random())*1e3,p(L)}let T=!1;function D(C){T||(T=!0,v(),!d&&(s!==null?(C||(l=2),clearTimeout(s),p(0)):C||(l=1)))}return p(0),i=setTimeout(()=>{o=!0,D(!0)},t),D}function H0(r){r(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class X0{constructor(e,t,n,s,i,o,l,c,d,m,p,v=!0){this.url_=e,this.method_=t,this.headers_=n,this.body_=s,this.successCodes_=i,this.additionalRetryCodes_=o,this.callback_=l,this.errorCallback_=c,this.timeout_=d,this.progressCallback_=m,this.connectionFactory_=p,this.retry=v,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((E,T)=>{this.resolve_=E,this.reject_=T,this.start_()})}start_(){const e=(n,s)=>{if(s){n(!1,new hi(!1,null,!0));return}const i=this.connectionFactory_();this.pendingConnection_=i;const o=l=>{const c=l.loaded,d=l.lengthComputable?l.total:-1;this.progressCallback_!==null&&this.progressCallback_(c,d)};this.progressCallback_!==null&&i.addUploadProgressListener(o),i.send(this.url_,this.method_,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&i.removeUploadProgressListener(o),this.pendingConnection_=null;const l=i.getErrorCode()===eo.NO_ERROR,c=i.getStatus();if(!l||Y0(c,this.additionalRetryCodes_)&&this.retry){const m=i.getErrorCode()===eo.ABORT;n(!1,new hi(!1,null,m));return}const d=this.successCodes_.indexOf(c)!==-1;n(!0,new hi(d,i))})},t=(n,s)=>{const i=this.resolve_,o=this.reject_,l=s.connection;if(s.wasSuccessCode)try{const c=this.callback_(l,l.getResponse());Q0(c)?i(c):i()}catch(c){o(c)}else if(l!==null){const c=U0();c.serverResponse=l.getErrorText(),this.errorCallback_?o(this.errorCallback_(l,c)):o(c)}else if(s.canceled){const c=this.appDelete_?dp():q0();o(c)}else{const c=B0();o(c)}};this.canceled_?t(!1,new hi(!1,null,!0)):this.backoffId_=W0(e,t,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,this.backoffId_!==null&&H0(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class hi{constructor(e,t,n){this.wasSuccessCode=e,this.connection=t,this.canceled=!!n}}function Z0(r,e){e!==null&&e.length>0&&(r.Authorization="Firebase "+e)}function eI(r,e){r["X-Firebase-Storage-Version"]="webjs/"+(e??"AppManager")}function tI(r,e){e&&(r["X-Firebase-GMPID"]=e)}function nI(r,e){e!==null&&(r["X-Firebase-AppCheck"]=e)}function rI(r,e,t,n,s,i,o=!0){const l=J0(r.urlParams),c=r.url+l,d=Object.assign({},r.headers);return tI(d,e),Z0(d,t),eI(d,i),nI(d,n),new X0(c,r.method,d,r.body,r.successCodes,r.additionalRetryCodes,r.handler,r.errorHandler,r.timeout,r.progressCallback,s,o)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
شكراً لتعاونكم. 🌹`;window.open(`https://wa.me/${se}?text=${encodeURIComponent(z)}`,"_blank")};return o?u.jsx("div",{className:"p-8 text-center text-slate-700 font-bold dir-rtl",children:"جاري تحميل ملفات التلاميذ..."}):u.jsxs("div",{className:"mx-auto w-full max-w-7xl space-y-6 dir-rtl text-right pb-10",children:[u.jsxs("div",{className:"flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-5 sm:p-6 rounded-2xl shadow-sm border border-slate-200",children:[u.jsxs("div",{children:[u.jsx("h2",{className:"text-2xl font-black text-slate-900",children:"إدارة ملفات التلاميذ 👥"}),u.jsx("p",{className:"text-sm font-bold text-slate-600",children:"إدارة معلومات التلاميذ والملفات الدراسية"})]}),u.jsx("button",{onClick:()=>E(!0),className:"w-full md:w-auto px-5 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-black shadow-lg shadow-indigo-600/20 transition",children:"➕ إضافة تلميذ جديد"})]}),m&&u.jsxs("div",{className:"p-4 bg-red-100 border-2 border-red-400 text-red-900 rounded-xl font-bold",children:["❌ ",m]}),r.length===0?u.jsx("div",{className:"bg-white rounded-xl border p-8 text-center font-bold text-slate-600",children:"لا يوجد تلاميذ حالياً."}):u.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5",children:r.map(y=>u.jsxs("div",{className:"bg-white rounded-2xl shadow-sm border border-slate-200 p-5 border-t-4 border-t-indigo-500 hover:-translate-y-0.5 hover:shadow-lg transition",children:[u.jsxs("div",{className:"border-b pb-3",children:[u.jsx("h3",{className:"text-xl font-black text-slate-900",children:y.full_name}),u.jsx("span",{className:"inline-block mt-2 px-3 py-1 bg-blue-100 text-blue-900 rounded-md text-xs font-black",children:P(y)})]}),u.jsxs("div",{className:"mt-4 space-y-2 text-sm font-bold text-slate-800",children:[u.jsxs("p",{children:["📞 هاتف الولي:",u.jsxs("span",{className:"text-blue-700",children:[" ",y.parent_phone||"—"]})]}),u.jsxs("p",{children:["🏫 المدرسة: ",y.original_school||"—"]}),u.jsxs("p",{children:["💰 الواجب الشهري: ",y.monthly_fee||0," درهم"]}),u.jsxs("p",{children:["👨‍🏫 الأستاذ: ",R(y)]})]}),u.jsxs("div",{className:"mt-5 flex gap-2",children:[u.jsx("button",{onClick:()=>D(y),className:"flex-1 py-2.5 bg-slate-800 hover:bg-slate-900 text-white rounded-lg font-black text-xs",children:"📂 فتح الملف"}),u.jsx("button",{onClick:()=>A(y),className:"px-3 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-black text-xs",children:"📲"}),u.jsx("button",{onClick:()=>I(y.id,y.full_name),className:"px-3 py-2.5 bg-red-100 hover:bg-red-200 text-red-700 rounded-lg font-black text-xs",children:"🗑️"})]})]},y.id))}),T&&u.jsx("div",{className:"fixed inset-0 bg-black/70 z-[99999] flex items-center justify-center p-4 overflow-y-auto",children:u.jsxs("div",{className:"bg-white rounded-xl shadow-2xl w-full max-w-3xl text-slate-900 max-h-[90vh] flex flex-col",children:[u.jsxs("div",{className:"flex justify-between items-center p-5 border-b bg-white rounded-t-xl shrink-0",children:[u.jsxs("div",{children:[u.jsx("h3",{className:"text-2xl font-black text-slate-900",children:"ملف التلميذ"}),u.jsx("p",{className:"text-lg font-bold text-blue-700",children:T.full_name})]}),u.jsx("button",{onClick:()=>D(null),className:"px-3 py-2 bg-slate-200 hover:bg-slate-300 rounded-lg font-black text-slate-700",children:"✖"})]}),u.jsxs("div",{className:"p-6 overflow-y-auto space-y-4 flex-1",children:[u.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:[u.jsxs("div",{className:"bg-slate-50 p-4 rounded-lg border border-slate-200",children:[u.jsx("strong",{className:"text-slate-900 block mb-1",children:"المستوى:"}),u.jsx("p",{className:"text-slate-800",children:P(T)})]}),u.jsxs("div",{className:"bg-slate-50 p-4 rounded-lg border border-slate-200",children:[u.jsx("strong",{className:"text-slate-900 block mb-1",children:"الأستاذ المسؤول:"}),u.jsx("p",{className:"text-slate-800",children:R(T)})]}),u.jsxs("div",{className:"bg-slate-50 p-4 rounded-lg border border-slate-200",children:[u.jsx("strong",{className:"text-slate-900 block mb-1",children:"هاتف الولي:"}),u.jsx("p",{className:"text-slate-800",children:T.parent_phone||"غير موجود"})]}),u.jsxs("div",{className:"bg-slate-50 p-4 rounded-lg border border-slate-200",children:[u.jsx("strong",{className:"text-slate-900 block mb-1",children:"الواجب الشهري:"}),u.jsxs("p",{className:"text-slate-800",children:[T.monthly_fee||0," درهم"]})]})]}),u.jsxs("div",{className:"bg-amber-50 border border-amber-200 rounded-xl p-4",children:[u.jsx("h4",{className:"font-black text-amber-900 mb-2",children:"📝 ملاحظات التلميذ"}),u.jsx("p",{className:"whitespace-pre-line text-slate-800",children:T.notes||"لا توجد ملاحظات."})]}),u.jsxs("div",{className:"bg-slate-100 p-4 rounded-xl border border-slate-200",children:[u.jsx("h4",{className:"font-black text-slate-900 mb-3",children:"✍️ إضافة ملاحظة بعد الحصة"}),u.jsxs("form",{onSubmit:b,className:"flex flex-col md:flex-row gap-2",children:[u.jsx("input",{type:"text",value:C,onChange:y=>F(y.target.value),placeholder:"اكتب الملاحظة...",className:"flex-1 p-3 border-2 border-slate-300 rounded-lg bg-white text-slate-900"}),u.jsx("button",{type:"submit",className:"px-5 py-3 bg-blue-700 hover:bg-blue-800 text-white rounded-lg font-black shrink-0",children:"إضافة ➕"})]})]})]}),u.jsxs("div",{className:"p-4 border-t bg-slate-50 rounded-b-xl flex gap-2 shrink-0",children:[u.jsx("button",{onClick:()=>A(T),className:"flex-1 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-black",children:"📲 تواصل مع الولي"}),u.jsx("button",{onClick:()=>I(T.id,T.full_name),className:"px-5 py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg font-black",children:"🗑️ أرشفة"})]})]})}),v&&u.jsx("div",{className:"fixed inset-0 bg-black/70 z-[99999] flex items-center justify-center p-4 overflow-y-auto",children:u.jsxs("div",{className:"bg-white rounded-2xl shadow-2xl w-full max-w-2xl text-slate-900 max-h-[85vh] overflow-y-auto flex flex-col my-auto",children:[u.jsxs("div",{className:"flex justify-between items-center p-5 border-b bg-white rounded-t-xl shrink-0",children:[u.jsx("h3",{className:"text-xl font-black text-slate-900",children:"إضافة تلميذ جديد 👨‍🎓"}),u.jsx("button",{type:"button",onClick:()=>{E(!1),_()},className:"px-3 py-1 bg-slate-200 hover:bg-slate-300 rounded-lg font-black text-slate-700",children:"✖"})]}),u.jsxs("form",{onSubmit:w,className:"flex flex-col flex-1 overflow-hidden",children:[u.jsxs("div",{className:"p-6 overflow-y-auto space-y-4 flex-1",children:[u.jsxs("div",{children:[u.jsx("label",{className:"font-bold block mb-1 text-slate-800",children:"الاسم الكامل *"}),u.jsx("input",{name:"full_name",required:!0,value:O.full_name,onChange:x,className:"w-full p-3 border-2 border-slate-300 rounded-lg bg-white text-slate-900",placeholder:"مثال: محمد العلمي"})]}),u.jsxs("div",{children:[u.jsx("label",{className:"font-bold block mb-1 text-slate-800",children:"المستوى الدراسي"}),u.jsxs("select",{name:"level_id",value:O.level_id,onChange:x,className:"w-full p-3 border-2 border-slate-300 rounded-lg bg-white text-slate-900",children:[u.jsx("option",{value:"",children:"اختيار المستوى"}),(s.length?s:bp.map(y=>({id:y,name_ar:y}))).map(y=>u.jsx("option",{value:y.id,children:y.name_ar},y.id))]})]}),u.jsx("div",{className:"grid md:grid-cols-2 gap-3",children:u.jsxs("div",{children:[u.jsx("label",{className:"font-bold block mb-1 text-slate-800",children:"هاتف الولي (WhatsApp) *"}),u.jsx("input",{name:"parent_phone",required:!0,value:O.parent_phone,onChange:x,className:"w-full p-3 border-2 border-slate-300 rounded-lg bg-white text-slate-900",placeholder:"0612345678"})]})}),u.jsxs("div",{children:[u.jsx("label",{className:"font-bold block mb-1 text-slate-800",children:"الواجب الشهري (درهم)"}),u.jsx("input",{type:"number",min:"0",name:"monthly_fee",value:O.monthly_fee,onChange:x,className:"w-full p-3 border-2 border-slate-300 rounded-lg bg-white text-slate-900"})]})]}),u.jsxs("div",{className:"p-4 border-t bg-slate-50 rounded-b-xl flex gap-2 shrink-0",children:[u.jsx("button",{type:"submit",disabled:c,className:"flex-1 py-3 bg-emerald-700 hover:bg-emerald-800 text-white rounded-lg font-black disabled:opacity-50",children:c?"جاري الحفظ...":"حفظ التلميذ ✅"}),u.jsx("button",{type:"button",onClick:()=>{E(!1),_()},className:"px-5 py-3 bg-slate-200 hover:bg-slate-300 rounded-lg font-black text-slate-800",children:"إلغاء"})]})]})]})})]})}function SI(){const{userRole:r="admin",currentUser:e=null}=js(),{students:t,setStudents:n}=Ms(),[s,i]=M.useState([]),[o,l]=M.useState({}),[c,d]=M.useState(new Date().toISOString().split("T")[0]),[m,p]=M.useState(""),[v,E]=M.useState(""),[T,D]=M.useState(!0),[C,F]=M.useState(!1),[O,L]=M.useState(!1),[$,P]=M.useState(""),R=M.useCallback(async()=>{D(!0),P("");try{const{data:z,error:H}=await Xe.from("students").select(`
          ...
          `).order("name");if(On)throw On;const{data:et,error:Ee}=await Xe.from("teachers").select(`
            ...
            user_id,
            status
          `).eq("status","active").order("full_name");if(Ee)throw Ee;const{data:Ls,error:Nt}=await Xe.from("attendance").select(`
          id,
          student_id,
          class_id,
          teacher_id,
